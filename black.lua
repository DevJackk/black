...
msg.Name_Controller = Redis:get(black.."black:Developer:Bot:Reply"..msg.chat_id) or 'Master'
...
--download('https://raw.githubusercontent.com/Sourceblack/black/master/black.lua','black.lua')
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله مسبقا Master 🎖 ").Reply,"md",true)  
else
Redis:srem(black.."black:DevelopersQ:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله Master 🎖").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله Master مسبقا ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله مسبقا Master 🎖 ").Reply,"md",true)  
else
Redis:srem(black.."black:DevelopersQ:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله Master 🎖").Reply,"md",true)  
end
end
if TextMsg == 'M' then
if not msg.DevelopersQ then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله Master مسبقا ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله مسبقا Master 🎖 ").Reply,"md",true)  
else
Redis:srem(black.."black:DevelopersQ:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله Master 🎖").Reply,"md",true)  
end
end
if UserId[1] == 'M' then
if not msg.DevelopersQ then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله Master مسبقا ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مسبقا Master 🎖 ").Reply,"md",true)  
else
Redis:sadd(black.."black:DevelopersQ:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته Master 🎖").Reply,"md",true)  
end
end
if UserName[1] == "M" then
if not msg.DevelopersQ then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته Master 🎖 مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."black:DevelopersQ:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته Master 🎖").Reply,"md",true)  
end
end
if TextMsg == 'M' then
if not msg.DevelopersQ then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم ترقيته Master 🎖 مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."black:DevelopersQ:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم ترقيته Master 🎖").Reply,"md",true)  
end
end
if UserId[1] == 'M' then
if not msg.DevelopersQ then
...
return LuaTele.sendText(msg_chat_id,msg_id,"• لا يوجد Master 🎖️ حاليا , ","md",true)  
end
ListMembers = '\n• قائمة MS\n ━━━━━\n'
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"• لا يوجد Master حاليا , ","md",true)  
end
ListMembers = '\n• قائمه Master البوت \n ━━━━━\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
{
{text = '❲ Tws ❳', url = "https://t.me/JOK_ER_7bot"}
},
{
{text = '❲ Coder ❳', url = "https://t.me/sJJJJJ"}
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,"[Source black](t.me/BLACK_TEAM_4)\n\n[Tws](t.me/JOK_ER_7bot)","md",true, false, false, false,reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"• تم مسح ( "..#Info_Members.." ) من Master ","md",true)
end
...
Redis:del(black.."black:DevelopersQ:Groups") 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم مسح ( "..#Info_Members.." ) من Master 🎖️ ","md",true)
end
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح Master', data = msg.sender.user_id..'/Developers'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(black.."black:Developers:Groups") 
LuaTele.editMessageText(ChatId,Msg_id,"• تم مسح Master البوت", 'md', false)
end
elseif Text and Text:match('(%d+)/DevelopersQ') then
local UserId = Text:match('(%d+)/DevelopersQ')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(black.."black:DevelopersQ:Groups") 
LuaTele.editMessageText(ChatId,Msg_id,"• تم مسح Master 🎖️ من البوت", 'md', false)
end
