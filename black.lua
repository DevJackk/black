...
https.request("https://gjacgkblagck.ml/apies/youtube/search.php?token="..Token.."&chat="..msg_chat_id.."&text="..URL.escape(search))
end
...
https.request("http://gjacgkblagck.ml/apies/youtube/script.php?token="..Token.."&chat="..ChatId.."&url="..mp3.."&type=mp3")
elseif Text and Text:match("ogg/(.*)") then
local ogg = Text:match("ogg/(.*)")
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
https.request("http://gjacgkblagck.ml/apies/youtube/script.php?token="..Token.."&chat="..ChatId.."&url="..ogg.."&type=ogg")
elseif Text and Text:match("mp4/(.*)") then
local mp4 = Text:match("mp4/(.*)")
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
https.request("http://gjacgkblagck.ml/apies/youtube/script.php?token="..Token.."&chat="..ChatId.."&url="..mp4.."&type=mp4")
end
...
if text and (text == "غنيلي" or text == "• غنيلي •") and not DevRio:get(black..'Rio:Audios:Rio'..msg.chat_id_) and ChCheck(msg) then
