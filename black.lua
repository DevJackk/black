...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑𝐒♆',url="https://t.me/BLACK_TEAM_4/1447"}‚{text = '𝐓𝐖𝐒ⶄ', url = 't.me/JOK_ER_7bot'}},
...
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and DevRio:get(black..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الخيانه" and text ~= "نسبة الخيانه" and text ~= "•  نسبه الخيانه • " and DevRio:get(black..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الجمال" and text ~= "نسبة الجمال" and text ~= "•  نسبه الجمال • " and DevRio:get(black..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and text ~= "•  نسبه الكره • " and DevRio:get(black..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and text ~= "•  نسبه الرجوله • " and DevRio:get(black..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and text ~= "•  نسبه الانوثه • " and DevRio:get(black..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and text ~= "•  نسبه الغباء • " and DevRio:get(black..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and (text == "متحركه" or text == "•  متحركه • ") and not DevRio:get(black..'Rio:gif:Rio'..msg.chat_id_) and ChCheck(msg) then
...
if text and (text == "ميمز" or text == "•  ميمز • ") and not DevRio:get(black..'Rio:memz:Rio'..msg.chat_id_) and ChCheck(msg) then
...
if text and (text == "اغنيه" or text == "•  اغنيه • " or text == "اغاني") and not DevRio:get(black..'Rio:mp3:Rio'..msg.chat_id_) and ChCheck(msg) then
...
if text and (text == "ريمكس" or text == "•  ريمكس • ") and not DevRio:get(black..'Rio:Remix:Rio'..msg.chat_id_) and ChCheck(msg) then
...
if text and (text == "صوره" or text == "•  صوره • ") and not DevRio:get(black..'Rio:Photo:Rio'..msg.chat_id_) and ChCheck(msg) then
...
if text and (text == "انمي" or text == "•  انمي • ") and not DevRio:get(black..'Rio:Anime:Rio'..msg.chat_id_) and ChCheck(msg) then
...
if text and (text == "فلم" or text == "•  فلم • ") and not DevRio:get(black..'Rio:Movies:Rio'..msg.chat_id_) and ChCheck(msg) then
...
if text and (text == "مسلسل" or text == "•  مسلسل • ") and not DevRio:get(black..'Rio:Series:Rio'..msg.chat_id_) and ChCheck(msg) then
