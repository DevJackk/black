...
return false end
if text==("عدد المجموعة") and Admin(msg) then
...
redis:del(bot_id..'black:tagall'..msg.chat_id_) 
Text = '\n اهلا عزيزي \n تم تفعيل امر @all' 
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل @all' and Admin(msg) then  
redis:set(bot_id..'black:tagall'..msg.chat_id_,true) 
Text = '\nاهلا عزيزي \n تم تعطيل امر @all' 
send(msg.chat_id_, msg.id_,Text) 
end 
if text == ("@all") and Admin(msg) and not redis:get(bot_id..'black:tagall'..msg.chat_id_) then
...
if text and text:match('@all (.*)') and Admin(msg) and not redis:get(bot_id..'black:tagall'..msg.chat_id_) then
LuaTele({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(argg,dataa) 
LuaTele({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = dataa.member_count_
},function(ta,black)
x = 0
...
local Leave = Dev_Bots:get(bot_id..'black:Leave')
local Text = [[
...
if DeveloperBot(msg) and not redis:get(bot_id.."black:Lock:Left"..msg.chat_id_) then 
...
redis:srem(bot_id.."black:ChekBotAdd",GP_ID[2])  
end
end
