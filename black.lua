...
--download('https://raw.githubusercontent.com/jack1eljoker1/black/main/black.lua?token=GHSAT0AAAAAABQBYKR4FTKGLPXJ3H22B7AGYO66YIA','black.lua')
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال جوكر و جاك و روز', 1, 'md')
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسمين لحساب نسبة الخيانه بينهما كمثال جوكر و جاك و روز', 1, 'md')
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسم الشخص لقياس نسبة جماله كمثال جوكر و جاك ', 1, 'md')
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال جوكر و جاك و روز', 1, 'md')
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال جوكر و جاك', 1, 'md')
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال جوكر و جاك ', 1, 'md')
end
end
...
if text == 'لاليليقاا' or text == 'ىاةيتبتت' then
local TextingDevblack = Redis:get(black..'black:Texting:Devblack')
if TextingDevblack then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevblack,"md",true)  
else
...
{
{text = '- قناة السورس.', url = 't.me/BLACK_TEAM_4'},{text = '- لتنصيب بوتك', url = 'https://t.me/BLACK_TEAM_4/1447'}, 
},
}
}
