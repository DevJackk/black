...
UserInfousername = '['..UserInfo.first_name.last_name..'](t.me/'..UserInfo.username..')'
else
UserInfousername = '['..UserInfo.first_name.last_name..'](tg://user?id='..UserId..')'
end
return {
...
Welcome = Welcome:gsub('name',UserInfo.first_name.last_name) 
Welcome = Welcome:gsub('user',UserInfousername) 
Welcome = Welcome:gsub('NameCh',Get_Chat.title) 
return LuaTele.sendText(msg_chat_id,msg_id,Welcome,"md")  
else
return LuaTele.sendText(msg_chat_id,msg_id,'❍ اطلق دخول ['..UserInfo.first_name.last_name..'](tg://user?id='..msg.sender.user_id..')\n❍ نورت الجروب {'..Get_Chat.title..'}',"md")  
end
end
end
...
local Text = Text:gsub('#name',UserInfo.first_name.last_name)
...
local Texingt = Texingt:gsub('#name',UserInfo.first_name.last_name)
...
LuaTele.sendText(Sudo_Id,0,'*\n❍ تم تفعيل مجموعه جديده \n❍ من قام بتفعيلها : {*['..UserInfo.first_name.last_name..'](tg://user?id='..msg.sender.user_id..')*} \n❍ معلومات المجموعه :\n❍ عدد الاعضاء : '..Info_Chats.member_count..'\n❍ عدد الادمنيه : '..Info_Chats.administrator_count..'\n❍ عدد المطرودين : '..Info_Chats.banned_count..'\n🔕︙عدد المقيدين : '..Info_Chats.restricted_count..'*',"md",true, false, false, false, reply_markup)
end
...
LuaTele.sendText(Sudo_Id,0,'*\n❍ تم تعطيل مجموعه جديده \n❍ من قام بتعطيلها : {*['..UserInfo.first_name.last_name..'](tg://user?id='..msg.sender.user_id..')*} \n❍ معلومات المجموعه :\n❍ عدد الاعضاء : '..Info_Chats.member_count..'\n❍ عدد الادمنيه : '..Info_Chats.administrator_count..'\n❍ عدد المطرودين : '..Info_Chats.banned_count..'\n🔕︙عدد المقيدين : '..Info_Chats.restricted_count..'*',"md",true, false, false, false, reply_markup)
end
...
if not msg.ControllerBot then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
for Name_User in string.gmatch(UserInfo.first_name.last_name, "[^%s]+" ) do
...
if ban.first_name.last_name then
news = " "..ban.first_name.last_name.." "
else
news = " لا يوجد"
end
...
if ban.first_name.last_name then
UserName = ' '..ban.first_name.last_name..' '
else
UserName = 'لا يوجد'
end
...
if ban.first_name.last_name then
baniusername = '*المستخدم :- *['..bana.first_name.last_name..'](tg://user?id='..bana.id..')*\n❍ تم تقييده في الجروب\nمن قبل :- *['..bain.first_name.last_name..'](tg://user?id='..bain.id..')*\n*'
else
...
if ban.first_name.last_name then
baniusername = '*المستخدم :- *['..ban.first_name.last_name..'](tg://user?id='..ban.id..')*\n❍ تم حظره عام من المجموعات\nمن قبل :- *['..bain.first_name.last_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
end
keyboard = {} 
...
local TestText = "- معلومات المالك : \n\n- [".. ban.first_name.last_name.."](tg://user?id=".. ban.id..")\n \n ["..Bio.."]"
local msg_id = msg.id/2097152/0.5 
...
if bains.first_name.last_name then
klajq = '*['..bains.first_name.last_name..'](tg://user?id='..bains.id..')*'
else
klajq = 'لا يوجد'
end
...
if photo.total_count > 0 then
local TestText = "  ‹[ Developers Bot ]›\nـًََِـًٍـًٍـًٍـًٍـًٍـًٍـًًٍٍـًََِـًٍـًٍـًٍـًٍـًٍـًٍـًََِـًٍـًٍ❍ـًََِـًٍـًٍـًٍـًٍـًٍـًٍـًًٍٍـًََِـًٍـًٍـًٍـًٍـًٍـًٍـًََِـًٍـًٍ\n ❍*Dev Name* :  [".. ban.first_name.last_name.."](tg://user?id="..Sudo_Id..")\n❍ *Dev Bio* : ["..Bio.." ]\n"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = Creat, url = "https://t.me/"..ban.username..""},
...
if photo.total_count > 0 then
local TestText = "  ‹[ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ]›\nـًََِـًٍـًٍـًٍـًٍـًٍـًٍـًًٍٍـًََِـًٍـًٍـًٍـًٍـًٍـًٍـًََِـًٍـًٍ❍ـًََِـًٍـًٍـًٍـًٍـًٍـًٍـًًٍٍـًََِـًٍـًٍـًٍـًٍـًٍـًٍـًََِـًٍـًٍ\n ❍*Dev Name* :  [".. ban.first_name.last_name.."](tg://user?id="..UserId_Info.id..")\n❍ *Dev Bio* : [‹[ "..Bio.." ]›]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
...
local TestText = "- معلومات مطور السورس : \\nn: name Dev . [".. ban.first_name.last_name.."](tg://user?id="..UserId_Info.id..")\n\n ["..Bio.."]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '< Developers black  >', url = "https://t.me/php_cx"}
...
local czczh = '*'..bains.first_name.last_name..'*'
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
local Name = '['..ban.first_name.last_name..'](tg://user?id='..Added_Me..')'
...
local bain = LuaTele.getUser(msg.sender.user_id)
if ban.first_name.last_name then
baniusername = '*طلب :- *['..bain.first_name.last_name..'](tg://user?id='..bain.id..')*\nالزواج من  :- *['..ban.first_name.last_name..'](tg://user?id='..ban.id..')*\nهل العروسه مواقفه علي هذا\n*'
else
baniusername = 'لا يوجد'
end
local reply_markup = LuaTele.replyMarkup{
...
x = x + 1
if UserInfo.first_name.last_name ~= '' then
listall = listall.." ["..UserInfo.first_name.last_name.."](tg://user?id="..UserInfo.id.."),"
end
if x == 5 or x == tags or k == 0 then
...
if UserInfo.username then
Creator = " "..UserInfo.first_name.last_name.." "
else
Creator = " بلاك\n"
end
...
if bain.first_name.last_name then
baniusername = '*['..bain.first_name.last_name..'](tg://user?id='..bain.id..')*'
else
baniusername = 'لا يوجد'
end
