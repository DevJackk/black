...
if text == 'جلب النسخه الاحتياطيه •' or text == 'جلب النسخه احتياطيه' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* • هاذا الامر يخص ‹ '..Controller_Num(1)..' ›* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
NamesBoto = (Redis:get(black.."black:Name:Bot") or "بلاك")
Groups = (Redis:scard(black..'black:ChekBotAdd') or 0)
Users = (Redis:scard(black..'black:Num:User:Pv') or 0)
if photo.total_count > 0 then
local NamesBoto = 'اسم بوت < '..NamesBoto..''
local Grosupsw = 'الجروبات < '..Groups..''
local Usperos = 'المشتركين < '..Users..''
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = NamesBoto, url = 't.me/BLACK_TEAM_4'}, 
},
{
{text = Grosupsw, url = 't.me/BLACK_TEAM_4'}, 
},
{
{text = Usperos, url = 't.me/BLACK_TEAM_4'}, 
},
}
...
{
{text = 'اوامر التفعيل والتعطيل', data = msg.sender.user_id..'/NoNextSeting'}, {text = 'اوامر الفتح والقفل', data = msg.sender.user_id..'/listallAddorrem'}, 
},
{
...
3 ‹ اوامر الاعضاء ›
4 ‹ اوامر المسح ›
5 ‹ اوامر التفعيل والتعطيل ›
6 ‹ اوامر الفتح والقفل ›
*]],"md",false, false, false, false, reply_markup)
elseif text == 'لالةننت' then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n• الامر يخص : ( '..Controller_Num(7)..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
...
{
{text = 'اوامر التفعيل والتعطيل', data = IdUser..'/NoNextSeting'}, {text = 'اوامر الفتح والقفل', data = IdUser..'/listallAddorrem'}, 
},
{
{text = '° sᴏᴜʀᴄᴇ ʙʟᴀᴄᴋ °', url = 't.me/BLACK_TEAM_4'}, 
},
