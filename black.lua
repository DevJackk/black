...
--]]
UPRL     = require("./libs/url")
JSHON    = require("./libs/dkjson")
...
SshId = io.poopen("echo $SSH_CLIENT ︙ awk '{ print $1}'"):read('*a')
...
local textt = 'رتبتك هي •'..Controller(msg_chat_id,UserId)
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = textt, url = 't.me/BLACK_TEAM_4'}, 
},
{
{text = 'اضف البوت لمجموعتك', url = 't.me/'..UserBot..'?startgroup=new'},
},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- Source black .',url="t.me/BLACK_TEAM_4"}},
}
