...
Status = Redis:get(Theblack.."black:Developer:Bot:Reply"..ChatId) or 'المطور'
...
Redis:incr(Theblack.."black:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(Theblack.."black:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(Theblack.."black:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(Theblack.."black:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
if text and text:match('^بحث (.*)$') and Redis:get(Theblack.."black:Status:yt"..msg.chat_id) then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(Theblack.."black:Group:Link"..msg_chat_id) 
if GetLink then
...
data = {
{
{text = 'قناة السورس', url = 'https://t.me/black'}, 
},
{
{text = 'الشروحات', url = 'https://t.me/EPX_black'}, 
},
{
...
if text == (Redis:get(Theblack.."black:Name:Bot") or "سنايبر") then
local NamesBot = (Redis:get(Theblack.."black:Name:Bot") or "سنايبر")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n⌔︙أهلآ بك في بوت '..(Redis:get(Theblack.."black:Name:Bot") or "سنايبر")..
