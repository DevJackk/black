...
local T = '* DEV BOT *['..ban.first_name..'](tg://user?id='..ban.id..')*\n*'
keyboard = {} 
...
redis:set(bot_id.."black:gamebot:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
redis:del(bot_id.."black:gamebot:List:Manager")
return send(msg.chat_id_, msg.id_,"تم حذف الاسئله")
end
if text and text:match("^(.*)$") then
if redis:get(bot_id.."black:gamebot:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\nتم حفظ السؤال بنجاح')
redis:set(bot_id.."black:gamebot:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1uu")
redis:sadd(bot_id.."black:gamebot:List:Manager", text)
return false end
end
if text == 'كت تويت' then

if redis:get(bot_id..'black:Lock:Game:Group'..msg.chat_id_) then
local list = redis:smembers(bot_id.."black:gamebot:List:Manager")
if #list ~= 0 then
...
[𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊🜾](t.me/BLACK_TEAM_4)
 ••━━━━━••𝐁𝐋𝐀𝐂𝐊••━━━━━••
[𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑𝐒🜾](https://t.me/BLACK_TEAM_4/1447)
 ••━━━━━••𝐁𝐋𝐀𝐂𝐊••━━━━━••
 [𝐀𝐃𝐃 𝐓𝐇𝐄 𝐁𝐎𝐓 𝐓𝐎 𝐘𝐎𝐔𝐑 𝐆𝐑𝐎𝐔𝐏𖠕](t.me/'..UserBot..'?startgroup=new)
...
usertext = '\n• العضو ⇠ ['..result.title_..'](t.me/'..(username or 'black')..')'
...
redis:set(bot_id.."black:Set:Id:Group"..msg.chat_id_,Text_Rand)
...
local Text_keyboard = '• اهلا بك عزيزي المطور \n في اوامرك الخاصه \n يمكنك تحكم في بوت عن طريق كيبورد ادناه '
local List_keyboard = {
{'تغيير اسم البوت'},
{'الاحصائيات'},
{'تفعيل تواصل','تعطيل تواصل'},
{'الاذاعه'},
{'مسح قائمة المطورين','مسح قائمة المطورين الثانوي'},
...
if not redis:get(bot_id..'black:Ban:Cmd:Start'..msg.sender_user_id_) then
local GetCmdStart = redis:get(bot_id.."black:Set:Cmd:Start:Bot")  
if not GetCmdStart then 
CmdStart = '\n• اهلا بك عزيزي \n انا بوت اسمي '..(redis:get(bot_id.."black:Redis:Name:Bot") or "بلاك")..''..
...
redis:setex(bot_id..'black:Ban:Cmd:Start'..msg.sender_user_id_,60,true)
return false
end
if not Dev_Bots(msg) and not redis:sismember(bot_id..'black:User:Ban:Pv',msg.sender_user_id_) and not redis:get(bot_id..'black:Lock:Twasl') then
...
if text == 'حظر' then
redis:sadd(bot_id..'black:User:Ban:Pv',UserForward)  
Send_Optionspv(Id_Dev,msg.id_,UserForward,"reply_Pv","• تم حظره من تواصل البوت")  
return false  
end
if text =='الغاء الحظر' then
redis:srem(bot_id..'black:User:Ban:Pv',UserForward) 
