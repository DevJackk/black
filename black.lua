...
photo = "https://t.me/BLACK_TEAM_4"
caption "welcome to source black"
local RinkBot = msg.Name_Controller
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption="..caption.."&photo="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
