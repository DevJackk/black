...
download('https://raw.githubusercontent.com/blackTEM/black/master/black.lua','black.lua')
...
if text == "سورس" and ChCheck(msg) or text == "السورس" and ChCheck(msg) or text == "↫  السورس ᥀" and ChCheck(msg) or text == "↫  السورس" and ChCheck(msg) then

Text = [[

Welcome To Source

[° sᴏᴜʀᴄᴇ ʙʟᴀᴄᴋ °](https://t.me/BLACK_TEAM_4)

]]

keyboard = {} 

keyboard.inline_keyboard = {{{text = ' ༄ Source Channel',url="https://t.me/BLACK_TEAM_4"}},{{text = ' ༄ Developer',url="t.me/BBlI9"},{text = ' ༄ Tws 𝐾𝐴𝐷𝐿',url="https://t.me/IFlFIGBOT"}},{{text= ' ༄ Exp Source .',url="https://t.me/s6_q3"}}}
...
if text == (Redis:get(black.."black:Name:Bot") or "السلطان") then
local NamesBot = (Redis:get(black.."black:Name:Bot") or "السلطان")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n•︙أهلآ بك في بوت '..(Redis:get(black.."black:Name:Bot") or "السلطان")..
