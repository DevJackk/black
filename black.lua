...
{
{text = 'تعطيل رتبتي', data = IdUser..'/'.. 'joker_jack'},{text = 'تفعيل رتبتي', data = IdUser..'/'.. 'jok_jak'},
},
{
...
elseif Text and Text:match('(%d+)/joker_jack') then
local UserId = Text:match('(%d+)/joker_jack')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(black.."black:photo:Rank"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
elseif Text and Text:match('(%d+)/jok_jak') then
local UserId = Text:match('(%d+)/jok_jak')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(black.."black:photo:Rank"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
