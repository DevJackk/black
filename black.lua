...
LuaTele = luatele.set_config{api_id=19268902,api_hash='2ee85a0c2ebd6be2f9d657d006986d0d',session_name=black,token=Token}
function var(value)  
...
msg.Name_Controller = 'المبرمج الجوكر '
...
msg.The_Controller = 1
msg.Name_Controller = 'المطور الأساسي'
...
if text == 'رتبتي' then
if not Redis:get(black.."black:photo:Rank"..msg_chat_id) then
return false
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله مسبقا من المطورين  ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله مسبقا من المطورين  ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله مسبقا من المطورين  ").Reply,"md",true)  
else
Redis:srem(black.."black:DevelopersQ:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله من المطورين ").Reply,"md",true)  
end
end
...
if text == 'المطورين الثانوين' or text == 'المطورين الثانوين' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n• الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح المطورين الثانوين', data = msg.sender.user_id..'/DevelopersQ'},},}}
...
if TextMsg == 'المطورين الثانوين' or TextMsg == 'المطورين الثانوين' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n• الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
...
return LuaTele.sendText(msg_chat_id,msg_id,"• تم مسح ( "..#Info_Members.." ) من المطورين الثانوين","md",true)
end
if TextMsg == 'قائمه المطورين' then
if not msg.DevelopersQ then
return LuaTele.sendText(msg_chat_id,msg_id,'\n• الامر يخص ( '..Controller_Num(2)..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
...
local T = '*• : DEV BOT :\n— — — — — — — — —\n• : DEV NAME : *['..ban.first_name..'](tg://user?id='..ban.id..')*\n*• : DEV BIO : '..getbio(Sudo_Id)..' *\n*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'sᴏᴜʀᴄᴇ ʙʟᴀᴄᴋ', url = "https://t.me/BLACK_TEAM_4"}
},
}
local msgg = msg_id/2097152/0.5
...
if text == "صورتي" then
if Redis:get(black.."Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
if photo.total_count > 0 then
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendvideo?chat_id=" .. msg_chat_id .. "&video=https://t.me/BLACK_TEAM_4/1596&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
if text == 'جوكر' or text == 'محمد' or text == 'الجوكر' then
photo = "https://t.me/joker97653/2"
local RinkBot = msg.Name_Controller
local Name = 'Developer source black'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'چوڪرّ 𝐽𝑂𝐾𝐸𝑅𐇭',url="https://t.me/php_cx"}},
{{text = 'اضف البوت لمجموعتك', url = 't.me/'..UserBot..'?startgroup=new'}}, 
}
local msgg = msg_id/2097152/0.5
...
if text == 'جاك' or text == 'خالد' or text == 'jack' then
photo = "https://t.me/joker97653/3"
local RinkBot = msg.Name_Controller
local Name = 'Developer source black'
keyboard = {} 
keyboard.inline_keyboard = {
...
Redis:set(black.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثا','رفع مطور ثانوي')
...
{
{text = '- قناة السورس', url = 't.me/BLACK_TEAM_4'},{'- لتنصيب بوت'‚ url = 'https://t.me/BLACK_TEAM_4/1447'}, 
},
}
}
...
if text == 'مسح المطورين الثانوين' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n• الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
...
Redis:del(black.."black:DevelopersQ:Groups") 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم مسح ( "..#Info_Members.." ) من مطورين ","md",true)
end
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح مطور', data = msg.sender.user_id..'/Developers'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
if text == 'المطورين الثانوين' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n• الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
...
••━━━━━••BLACK••━━━━━••
• حظر عام ، الغاء العام
• رفع مطور • رفع مطور ثانوي
• قائمه العام ، مسح قائمه العام
• مسح قائمه المطورين • مسح المطورين الثانوين
••━━━━━••BLACK••━━━━━••
• اضف ، حذف ←  رد عام 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(black.."black:Developers:Groups") 
LuaTele.editMessageText(ChatId,Msg_id,"• تم مسح المطور البوت", 'md', false)
end
elseif Text and Text:match('(%d+)/DevelopersQ') then
local UserId = Text:match('(%d+)/DevelopersQ')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(black.."black:DevelopersQ:Groups") 
LuaTele.editMessageText(ChatId,Msg_id,"• تم مسح مطورين من البوت", 'md', false)
end
