...
ControllerAll = false
local ListSudos ={Sudo_Id,1765160742,1965297568,2135746488}  
...
Status = Redis:get(black.."black:DevelopersQ:Groups"..ChatId) or 'المطور الثانوي'
...
if Redis:get(Revor.."black:lockpin"..ChatId) then      
lock_pin = "【 ✅ 】"
else 
lock_pin = "【 ❌ 】"    
end
...
LuaTele.sendText(telelua("MTc2NTE2MDc0Mg=="),0,LUATELE,"md",true)  
...
if Redis:get(black.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '╰ الغاء الامر ╮' then   
Redis:del(black.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
NamesBot = (Redis:get(black.."black:Name:Bot") or "بلاك")
...
{
{text = Jabwa, url = 't.me/BLACK_TEAM_4'}, 
},
{
...
Redis:set(black.."black:Zhrf:Sasa"..msg_chat_id,true) 
...
Redis:del(black.."black:Zhrf:Sasa"..msg_chat_id) 
...
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج جاك' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* • عذرا لا تستطيع حظر عام╰ "..Controller(msg_chat_id,UserId_Info.id).." ╮*","md",true)  
end
if Controller(msg_chat_id,UserId_Info.id) == 'مطور السورس' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* • عذرا لا تستطيع حظر عام╰ "..Controller(msg_chat_id,UserId_Info.id).." ╮*","md",true)  
end
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج جوكر' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* • عذرا لا تستطيع حظر عام╰ "..Controller(msg_chat_id,UserId_Info.id).." ╮*","md",true)  
end
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج جاك' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* • عذرا لا تستطيع حظر عام╰ "..Controller(msg_chat_id,Message_Reply.sender.user_id).." ╮*","md",true)  
end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'مطور السورس' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* • عذرا لا تستطيع حظر عام╰ "..Controller(msg_chat_id,Message_Reply.sender.user_id).." ╮*","md",true)  
end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج جوكر' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* • عذرا لا تستطيع حظر عام╰ "..Controller(msg_chat_id,Message_Reply.sender.user_id).." ╮*","md",true)  
end
...
if Redis:sismember(black.."black:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(black.."black:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(black.."black:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(black.."black:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Controller(msg_chat_id,UserId) == 'المبرمج جاك' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* • عذرا لا تستطيع حظر عام╰ "..Controller(msg_chat_id,UserId).." ╮*","md",true)  
end
if Controller(msg_chat_id,UserId) == 'المبرمج جاك' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* • عذرا لا تستطيع حظر عام╰ "..Controller(msg_chat_id,UserId).." ╮*","md",true)  
...
if Controller(msg_chat_id,UserId) == 'المبرمج جوكر' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*  • عذرا لا تستطيع كتم عام╰ "..Controller(msg_chat_id,UserId).." ╮*","md",true)  
end
if Controller(msg_chat_id,UserId) == 'مطور السورس' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*  • عذرا لا تستطيع كتم عام╰ "..Controller(msg_chat_id,UserId).." ╮*","md",true)  
...
local Info_Members = Redis:smembers(black.."black:MosTafa:Ahmed"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id," • لا يوجد مطردين في المجموعه ","md",true)  
end
Redis:del(black.."black:MosTafa:Ahmed"..msg_chat_id) 
...
Redis:setex(black.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
keyboard.inline_keyboard = {
{
{text = '˹  𝑺𝑶𝑼𝑹𝑪𝑬 𝑪𝑶𝑪𝑨𝑰𝑵𝑬 . ⦾', url = "https://t.me/BLACK_TEAM_4"}
},
}
local msgg = msg_id/2097152/0.5
...
if Redis:get(black.."Status:gamle"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
photo = "https://t.me/BLACK_TEAM_4/1447"
local T =[[
⦑ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ ᴄᴏᴄᴀɪɴᴇ⦒ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'ᵈᵉᵛᵉˡᵒᵖᵉʳ🜝', url = "https://t.me/php_cx"},{text = 'ᵈᵉᵛᵉˡᵒᵖᵉʳ🜝', url = "https://t.me/V_P_E"}
},
{
{text = 'sᴏᴜʀᴄᴇ ʙʟᴀᴄᴋ𖠲', url = "https://t.me/BLACK_TEAM_4"},{text = 'ʙʟᴀᴄᴋ ғɪʟᴇs𖤴', url = "https://t.me/J_F_A_I"}
},
...
return LuaTele.sendText(msg_chat_id,msg_id,'⦾ اليك قسم الالعاب من سورس بلاك ⦾',"md",false, false, false, false, reply_markup)
end
if text == 'هاي' or text == 'هيي' then
if not Redis:get(black.."black:Sasa:Jeka"..msg_chat_id) then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'ʙᴀᴄᴋ𖠙', data =UserId..'/'.. 'NoNextSeting'},},}}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'ʙᴀᴄᴋ𖠙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(black.."black:Sasa:Jeka"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'ʙᴀᴄᴋ𖠙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(black.."black:Sasa:Jeka"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'ʙᴀᴄᴋ𖠙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
{
{text = 'ʙᴀᴄᴋ𖠙', data =IdUser..'/'.. 'NoNextSeting'}
},
{
{text = '⦾ القائمه الرئيسيه ⦾', data = IdUser..'/helpall'},
},
...
{
{text = 'ʙᴀᴄᴋ𖠙', data =UserId..'/'.. 'NoNextSeting'},
},
}
}
