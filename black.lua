...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*• تم تنزيل الشخص من الرتب التاليه { "..devv..""..dev..""..crr..""..cr..""..own..""..mod..""..vip.." *}","md",true)  
end
...
if not msg.ControllerBot and not Redis:set(Devid.."Devid:SendBcBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*• امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/L9L9L'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
Redis:setex(Devid.."Devid:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف •  ملصق •  متحركه •  صوره
 •  فيديو •  بصمه الفيديو •  بصمه •  صوت •  رساله ❩
...
Redis:setex(Devid.."Devid:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف •  ملصق •  متحركه •  صوره
 •  فيديو •  بصمه الفيديو •  بصمه •  صوت •  رساله ❩
...
Redis:setex(Devid.."Devid:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف •  ملصق •  متحركه •  صوره
 •  فيديو •  بصمه الفيديو •  بصمه •  صوت •  رساله ❩
...
Redis:setex(Devid.."Devid:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(Devid.."Devid:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
if text == 'جوكر' or text == 'الجوكر' or text == 'محمد'  then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
{text = 'Channel ،', url = 't.me/UU_KFUF'}, 
},
{
{text = 'Communication', url = 't.me/JOK_ER_7bot'}, 
},
{
{text = 'Group1', url = 'https://t.me/+W7UzQtK_5udkNGVk'}, 
},
{
{text = 'Group2', url = 'https://t.me/+jPfUjh69v5g1ZjRk'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
*[° Developer Source °](https://t.me/php_cx) *
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
...
return LuaTele.sendText(msg_chat_id,msg_id, [[
*[° Source black °](https://t.me/BLACK_TEAM_4) *
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
]],"md",false, false, false, false, reply_markup)
