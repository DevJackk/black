...
if Redis:get(black.."Status:kool"..msg.chat_id) then
...
if text == "kjjhthff" or text == "vfg bgf" then
if Redis:get(black.."black:Status:Games"..msg.chat_id) then
...
send(msg.chat_id_, msg.id_,"• ارسل الان الكلمه لحذفها من الردود العامة ")
redis:set(bot_id.."black:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text=="اذاعه خاص •" then 
if not msg.Developers then
