...
LuaTele = luatele.set_config{api_id=10332903,api_hash='17598f27636c07b3c8a14327828e6e02',session_name=black,token=Token}
function var(value)  
...
ControllerAll = false
local ListSudos ={Sudo_Id,1765160742,1965297568}
...
MsgText = 'تفاعلك ضعيف جدا'
elseif tonumber(Message) < 400 then 
MsgText = 'حسن تفاعلك' 
elseif tonumber(Message) < 700 then 
MsgText = 'تفعل ضعيف بس حلو' 
elseif tonumber(Message) < 1200 then 
MsgText = 'تفاعل عظمه' 
elseif tonumber(Message) < 2000 then 
MsgText = 'ملك التفاعل' 
elseif tonumber(Message) < 3500 then 
MsgText = 'كينج التفاعل'  
elseif tonumber(Message) < 4000 then 
MsgText = 'تفاعل جمدان' 
elseif tonumber(Message) < 4500 then 
MsgText = 'اساس التفاعل' 
elseif tonumber(Message) < 5500 then 
MsgText = 'استمر علي هذا التفاعل' 
elseif tonumber(Message) < 7000 then 
MsgText = 'غنبله وربي 🌟' 
elseif tonumber(Message) < 9500 then 
MsgText = 'عاشش تفاغل ناااار' 
...
elseif tonumber(msg.sender.user_id) == 1965297568 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
...
{
{text = 'Source black', url='https://t.me/BLACK_TEAM_4'},
},
}
}
...
Redis:del(black.."black:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
Redis:set(black.."black:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(black.."black:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(black.."black:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(black.."black:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(black.."black:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(black.."black:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(black.."black:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(black.."black:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(black.."black:PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(black.."black:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر • ' then   
Redis:del(black.."black:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(black.."black:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر • ' then   
...
--download('https://raw.githubusercontent.com/AhmedElsayed111/BOBXV/master/black.lua','black.lua')
...
LuaTele.sendText(msg_chat_id,msg_id,'*• عدد احصائيات البوت الكامله \n••━━━━━ •• 𝐁𝐋𝐀𝐂𝐊•• ━━━━━••\n• عدد المجموعات : '..(Redis:scard(black..'black:ChekBotAdd') or 0)..'\n• عدد المشتركين : '..(Redis:scard(black..'black:Num:User:Pv') or 0)..'*',"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'• عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(black..'black:Num:Add:Bot'),"md",true)  
end
...
Redis:set(black.."black:photo:Rank"..msg_chat_id,true) 
...
Redis:set(black.."Status:photo"..msg_chat_id,true) 
...
if text and text:match("^(.*)$") then
if Redis:get(black.."black1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(black.."black1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(black.."black1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(black.."black1:List:Rd:Sudo"..msg.chat_id, text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:del(black.."black:photo:Rank"..msg_chat_id) 
...
if text == "الرابط" then
if not database:get(black.."Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"•︙ تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = database:get(black.."Group:Link"..msg_chat_id) 
if GetLink then
...
LuaTele.sendText(msg_chat_id,msg_id,'• عدد رسائلك هنا *~ '..(Redis:get(black..'black:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'• عدد التعديلات هنا *~ '..(Redis:get(black..'black:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'• عدد جهاتك المضافه هنا *~ '..(Redis:get(black.."black:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
https.request("https://black1.tk/apies/youtube/script.php?token="..Token.."&chat="..msg_chat_id.."&text="..URL.escape(search))
end
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(black..'black:Channel:Join')}, },}}
...
keyboard.inline_keyboard = {
{
{text = ban.first_name, url = 't.me/BLACK_TEAM_4'}, 
},
}
...
if text == 'الجوكر' or text == 'محمد' or text == 'جوكر' then
photo = "https://t.me/bahjat78/9"
local RinkBot = msg.Name_Controller
local Name = '𝐏𝐑𝐎𝐆𝐑𝐀𝐌𝐌𝐄𝐑🝁'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐉𝐎𝐊𝐄𝐑🜾',url="https://t.me/php_cx"}},
{{text = 'اضف البوت لمجموعتك', url = 't.me/'..UserBot..'?startgroup=new'}}, 
}
local msgg = msg_id/2097152/0.5
...
if text == 'جاك' or text == 'خالد' or text == 'المبرمج جاك' then
photo = "https://t.me/bahjat78/10"
local RinkBot = msg.Name_Controller
local Name = '𝐏𝐑𝐎𝐆𝐑𝐀𝐌𝐌𝐄𝐑🝁'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐉𝐀𝐂𝐊🝉',url="https://t.me/V_P_E"}},
{{text = 'اضف البوت لمجموعتك', url = 't.me/'..UserBot..'?startgroup=new'}}, 
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&photo="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local T =[[
• 𝐖𝐄𝐋𝐂𝐎𝐌 𝐓𝐎 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 .
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑𝐒♆',url="https://t.me/BLACK_TEAM_4/1447"}},
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊𖤓', url = "http://t.me/BLACK_TEAM_4"}},
{{text = 'اضف البوت لمجموعتك', url = 't.me/'..UserBot..'?startgroup=new'}}, 
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo=https://t.me/BLACK_TEAM_4/1406&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = ' أوامر القفل والفتح ', data = msg.sender.user_id..'/NoNextSeting'}, {text = ' أوامر التفعيل والتعطيل ', data = msg.sender.user_id..'/listallAddorrem'}, 
},
{
{text = '- قناة السورس', url = 't.me/BLACK_TEAM_4'}, 
},
...
data = {
{
{text = 'اوامر الحمايه» { 👊 }', data = '/Mahibes1'}, {text = 'اوامر الادمنيه » { 👊 }', data = '/Mahibes2'}, 
},
{
{text = 'اوامر المدراء » { 👊 }', data = '/Mahibes3'}, {text = 'اوامر المنشئين » { 👊 }', data = '/Mahibes4'}, 
},
{
{text = 'اوامر مطورين البوت » { 👊 }', data = '/Mahibes5'}, {text = '𝟔 » { 👊 }', data = '/Mahibes6'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[*
...
https.request("https://black1.tk/apies/youtube/download.php?token="..Token.."&chat="..ChatId.."&url="..mp3.."&type=mp3")
elseif Text and Text:match("ogg/(.*)") then
local ogg = Text:match("ogg/(.*)")
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
https.request("https://black1.tk/apies/youtube/download.php?token="..Token.."&chat="..ChatId.."&url="..ogg.."&type=ogg")
elseif Text and Text:match("mp4/(.*)") then
local mp4 = Text:match("mp4/(.*)")
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
https.request("https://black1.tk/apies/youtube/download.php?token="..Token.."&chat="..ChatId.."&url="..mp4.."&type=mp4")
end
...
local CmdStart = '*\n• أهلآ بك في بوت '..(Redis:get(black.."black:Name:Bot") or "بلاك")..
...
{
{text = '- قناة السورس.', url = 't.me/BLACK_TEAM_4'},{text = '- لتنصيب بوتك', url = 'https://t.me/xb8bbot'}, 
},
}
}
...
{
{text = 'اذاعه بالتوجيه • ',type = 'text'},{text = 'اذاعه خاص بالتوجيه • ', type = 'text'},
},
{
...
Redis:del(black.."black:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(black.."black1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(black.."black:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(black.."black:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(black.."black1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(black.."black:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"•  ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(black.."black:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"•  ارسل لي الرد الان", 'md', true)
end
end
...
data = {
{
{text = 'اوامر الحمايه» { '..Mahibes1..' }', data = '/*'}, {text = 'اوامر الادمنيه » { '..Mahibes2..' }', data = '/*'}, 
},
{
{text = 'اوامر المدراء » { '..Mahibes3..' }', data = '/*'}, {text = 'اوامر المنشئين » { '..Mahibes4..' }', data = '/*'}, 
},
{
{text = 'اوامر مطورين البوت » { '..Mahibes5..' }', data = '/*'}, {text = '𝟔 » { '..Mahibes6..' }', data = '/*'}, 
},
{
...
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تفعيل الزخرفه بنجاح'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:del(black..'black:Zrf:black'..msg.chat_id_) 
end
if text == "تعطيل الزخرفه" and Manager(msg) and ChCheck(msg) then
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تعطيل الزخرفه بنجاح'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:set(black..'black:Zrf:black'..msg.chat_id_,true)  
end
if Devblack:get(black..'Zrf:black'..msg.chat_id_..msg.sender_user_id_) then 
if text and text == 'الغاء' then 
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙تم الغاء امر الزخرفه', 1, 'md')
Devblack:del(black..'Zrf:black'..msg.chat_id_..msg.sender_user_id_)
return false  
end 
...
Dev_black(msg.chat_id_, msg.id_, 1, t, 1, 'md')
Devblack:del(black..'Zrf:black'..msg.chat_id_..msg.sender_user_id_)
return false   
end
if not Devblack:get(black..'black:Zrf:black'..msg.chat_id_) then
if text == 'زخرفه' and ChCheck(msg) or text == 'الزخرفه' and ChCheck(msg) then  
Devblack:setex(black.."Zrf:black"..msg.chat_id_..msg.sender_user_id_,300,true)
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙ارسل لي الكلمه لزخرفتها \nيمكنك الزخرفة باللغه { en } ~ { ar } ', 1, 'md')
end
end
if not Devblack:get(black..'black:Zrf:black'..msg.chat_id_) then
...
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:del(black..'black:Brg:black'..msg.chat_id_) 
end
if text == "تعطيل الابراج" and Manager(msg) and ChCheck(msg) then
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تعطيل الابراج بنجاح'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:set(black..'black:Brg:black'..msg.chat_id_,true)  
end
if not Devblack:get(black..'black:Brg:black'..msg.chat_id_) then
if text and text:match("^برج (.*)$") and ChCheck(msg) or text and text:match("^برجي (.*)$") and ChCheck(msg) then 
local TextBrg = text:match("^برج (.*)$") or text:match("^برجي (.*)$") 
UrlBrg = https.request('https://apiabs.ml/brg.php?brg='..URL.escape(TextBrg)) 
Brg = JSON.decode(UrlBrg) 
t = Brg.ok.abs  
Dev_black(msg.chat_id_, msg.id_, 1, t, 1, 'html')
end
end
-------------------------
...
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:del(black..'black:Nsba:black'..msg.chat_id_) 
end
...
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:set(black..'black:Nsba:black'..msg.chat_id_,true)  
end
if not Devblack:get(black..'black:Nsba:black'..msg.chat_id_) then
if text == "نسبه الحب" and ChCheck(msg) or text == "نسبة الحب" and ChCheck(msg) then
Devblack:set(black..'LoveNsba:black'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال الجوكر و بلاك و بسبوسه', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and Devblack:get(black..'LoveNsba:black'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙تم الغاء امر نسبة الحب ', 1, 'md')
Devblack:del(black..'LoveNsba:black'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
black = math.random(0,100);
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙نسبة الحب بين '..text..' هي : '..black..'%', 1, 'md')
Devblack:del(black..'LoveNsba:black'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not Devblack:get(black..'black:Nsba:black'..msg.chat_id_) then
if text == "نسبه الخيانه" and ChCheck(msg) or text == "نسبة الخيانه" and ChCheck(msg) or text == "•  نسبه الخيانه • " and ChCheck(msg) then
Devblack:set(black..'RyNsba:black'..msg.chat_id_..msg.sender_user_id_,true)
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙قم بارسل اسمين لحساب نسبة الخيانه بينهما كمثال الجوكر و بلاك و بسبوسه', 1, 'md')
end
end
if text and text ~= "نسبه الخيانه" and text ~= "نسبة الخيانه" and text ~= "•  نسبه الخيانه • " and Devblack:get(black..'RyNsba:black'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙تم الغاء امر نسبة الخيانه ', 1, 'md')
Devblack:del(black..'RyNsba:black'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
black = math.random(0,100);
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙نسبة الخيانه بين '..text..' هي : '..black..'%', 1, 'md')
Devblack:del(black..'RyNsba:black'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not Devblack:get(black..'black:Nsba:black'..msg.chat_id_) then
if text and (text == "نسبه الجمال" or text == "نسبة الجمال" or text == "•  نسبه الجمال • ") and ChCheck(msg) then
Devblack:set(black..'JNsba:black'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙قم بارسل اسم الشخص لقياس نسبة جماله كمثال الجوكر و بلاك ', 1, 'md')
end
end
if text and text ~= "نسبه الجمال" and text ~= "نسبة الجمال" and text ~= "•  نسبه الجمال • " and Devblack:get(black..'JNsba:black'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙تم الغاء امر نسبة الجمال ', 1, 'md')
Devblack:del(black..'JNsba:black'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
black = math.random(0,100);
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙نسبة جمال '..text..' هي : '..black..'%', 1, 'md')
Devblack:del(black..'JNsba:black'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not Devblack:get(black..'black:Nsba:black'..msg.chat_id_) then
if text == "نسبه الكره" and ChCheck(msg) or text == "نسبة الكره" and ChCheck(msg) or text == "•  نسبه الكره • " and ChCheck(msg) then
Devblack:set(black..'HataNsba:black'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال الجوكر و بلاك و بسبوسه', 1, 'md')
end
end
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and text ~= "•  نسبه الكره • " and Devblack:get(black..'HataNsba:black'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙تم الغاء امر نسبة الكره ', 1, 'md')
Devblack:del(black..'HataNsba:black'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
black = math.random(0,100);
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙نسبة الكره بين '..text..' هي : '..black..'%', 1, 'md')
Devblack:del(black..'HataNsba:black'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not Devblack:get(black..'black:Nsba:black'..msg.chat_id_) then
...
Devblack:set(black..'RjolaNsba:black'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال الجوكر و بلاك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and text ~= "•  نسبه الرجوله • " and Devblack:get(black..'RjolaNsba:black'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙تم الغاء امر نسبة الرجوله ', 1, 'md')
Devblack:del(black..'RjolaNsba:black'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
black = math.random(0,100);
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙نسبة رجولة '..text..' هي : '..black..'%', 1, 'md')
Devblack:del(black..'RjolaNsba:black'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not Devblack:get(black..'black:Nsba:black'..msg.chat_id_) then
...
Devblack:set(black..'AnothaNsba:black'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙قم بارسل اسم الشخص لقياس نسبة انوثته كمثال •  بسبوسه', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and text ~= "•  نسبه الانوثه • " and Devblack:get(black..'AnothaNsba:black'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙تم الغاء امر نسبة الانوثه ', 1, 'md')
Devblack:del(black..'AnothaNsba:black'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
black = math.random(0,100);
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙نسبة انوثة '..text..' هي : '..black..'%', 1, 'md')
Devblack:del(black..'AnothaNsba:black'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not Devblack:get(black..'black:Nsba:black'..msg.chat_id_) then
if text and (text == "نسبه الغباء" or text == "نسبة الغباء" or text == "•  نسبه الغباء • ") and ChCheck(msg) then
Devblack:set(black..'StupidNsba:black'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال الجوكر و بلاك ', 1, 'md')
end
end
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and text ~= "•  نسبه الغباء • " and Devblack:get(black..'StupidNsba:black'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙تم الغاء امر نسبة الغباء ', 1, 'md')
Devblack:del(black..'StupidNsba:black'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
black = math.random(0,100);
Dev_black(msg.chat_id_, msg.id_, 1, '• ︙نسبة غباء '..text..' هي : '..black..'%', 1, 'md')
Devblack:del(black..'StupidNsba:black'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
-------------------------
...
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تفعيل حساب العمر'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:del(black..'black:Age:black'..msg.chat_id_) 
end
if text == "تعطيل حساب العمر" and Manager(msg) and ChCheck(msg) then
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تعطيل حساب العمر'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:set(black..'black:Age:black'..msg.chat_id_,true)  
end
if not Devblack:get(black..'black:Age:black'..msg.chat_id_) then
...
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:del(black..'black:Mean:black'..msg.chat_id_) 
end
if text == "تعطيل معاني الاسماء" and Manager(msg) and ChCheck(msg) then
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تعطيل معاني الاسماء'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:set(black..'black:Mean:black'..msg.chat_id_,true)  
end
if not Devblack:get(black..'black:Mean:black'..msg.chat_id_) then
...
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تفعيل المتحركه'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:del(black..'black:gif:black'..msg.chat_id_) 
end
if text == "تعطيل متحركه" and Manager(msg) and ChCheck(msg) or text == "تعطيل المتحركه" and Manager(msg) and ChCheck(msg) then
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تعطيل المتحركه'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:set(black..'black:gif:black'..msg.chat_id_,true)  
end
if text and (text == "متحركه" or text == "•  متحركه • ") and not Devblack:get(black..'black:gif:black'..msg.chat_id_) and ChCheck(msg) then
black = math.random(2,1075); 
local Text ='*• ︙تم اختيار المتحركه لك*'
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑𝐒♆',url="https://t.me/BLACK_TEAM_4/1447"}},
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊𖤓',url="t.me/BLACK_TEAM_4"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/GifDavid/'..black..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
-------------------------
if text == "تفعيل ميمز" and Manager(msg) and ChCheck(msg) or text == "تفعيل الميمز" and Manager(msg) and ChCheck(msg) then
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تفعيل الميمز'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:del(black..'black:memz:black'..msg.chat_id_) 
end
if text == "تعطيل ميمز" and Manager(msg) and ChCheck(msg) or text == "تعطيل الميمز" and Manager(msg) and ChCheck(msg) then
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تعطيل الميمز'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:set(black..'black:memz:black'..msg.chat_id_,true)  
end
if text and (text == "ميمز" or text == "•  ميمز • ") and not Devblack:get(black..'black:memz:black'..msg.chat_id_) and ChCheck(msg) then
black = math.random(2,1201); 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/MemzDavid/'..black..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
-------------------------
...
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تفعيل غنيلي'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:del(black..'black:Audios:black'..msg.chat_id_) 
end
if text == "تعطيل غنيلي" and Manager(msg) and ChCheck(msg) then
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تعطيل غنيلي'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:set(black..'black:Audios:black'..msg.chat_id_,true)  
end
if text == "غنيلي" then
local t = "Your song"
Rv = math.random(8,83)
Ss = math.random(108,143)
Sss = math.random(166,179)
ssss = math.random(198,216)
Son = math.random(257,626)
local Texting = {Rv,Ss,Sss,ssss,Son}
local Rrr = Texting[math.random(#Texting)]
local m = "https://t.me//"..Rrr..""
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'قناه السورس', url"t.me/BLACK_TEAM_4"},
},
}
local rep = msg.id/2097152/0.5
...
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تفعيل الاغاني'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:del(black..'black:mp3:black'..msg.chat_id_) 
end
if text == "تعطيل الاغاني" and Manager(msg) and ChCheck(msg) or text == "تعطيل اغنيه" and Manager(msg) and ChCheck(msg) then
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تعطيل الاغاني'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:set(black..'black:mp3:black'..msg.chat_id_,true)  
end
if text and (text == "اغنيه" or text == "•  اغنيه • " or text == "اغاني") and not Devblack:get(black..'black:mp3:black'..msg.chat_id_) and ChCheck(msg) then
black = math.random(2,1167); 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/hhhbobxv/'..black..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
-------------------------
if text == "تفعيل ريمكس" and Manager(msg) and ChCheck(msg) or text == "تفعيل الريمكس" and Manager(msg) and ChCheck(msg) then
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تفعيل الريمكس'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:del(black..'black:Remix:black'..msg.chat_id_) 
end
if text == "تعطيل ريمكس" and Manager(msg) and ChCheck(msg) or text == "تعطيل الريمكس" and Manager(msg) and ChCheck(msg) then
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تعطيل الريمكس'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:set(black..'black:Remix:black'..msg.chat_id_,true)  
end
if text and (text == "ريمكس" or text == "•  ريمكس • ") and not Devblack:get(black..'black:Remix:black'..msg.chat_id_) and ChCheck(msg) then
black = math.random(2,612); 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/RemixDavid/'..black..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source black     --
if text == "تفعيل صوره" and Manager(msg) and ChCheck(msg) or text == "تفعيل الصوره" and Manager(msg) and ChCheck(msg) then
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تفعيل الصوره'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:del(black..'black:Photo:black'..msg.chat_id_) 
end
if text == "تعطيل صوره" and Manager(msg) and ChCheck(msg) or text == "تعطيل الصوره" and Manager(msg) and ChCheck(msg) then
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تعطيل الصوره'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:set(black..'black:Photo:black'..msg.chat_id_,true)  
end
if text and (text == "صوره" or text == "•  صوره • ") and not Devblack:get(black..'black:Photo:black'..msg.chat_id_) and ChCheck(msg) then
black = math.random(4,1122); 
local Text ='*• ︙تم اختيار الصوره لك*'
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑𝐒♆',url="https://t.me/BLACK_TEAM_4/1447"}},
{{text = '•  𝙎𝙊??𝙍𝘾𝙀 𝙎𝙉𝘼𝙆 .',url="t.me/BLACK_TEAM_4"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/PhotosDavid/'..black..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source black     --
if text == "تفعيل انمي" and Manager(msg) and ChCheck(msg) or text == "تفعيل الانمي" and Manager(msg) and ChCheck(msg) then
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تفعيل الانمي'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:del(black..'black:Anime:black'..msg.chat_id_) 
end
if text == "تعطيل انمي" and Manager(msg) and ChCheck(msg) or text == "تعطيل الانمي" and Manager(msg) and ChCheck(msg) then
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تعطيل الانمي'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:set(black..'black:Anime:black'..msg.chat_id_,true)  
end
if text and (text == "انمي" or text == "•  انمي • ") and not Devblack:get(black..'black:Anime:black'..msg.chat_id_) and ChCheck(msg) then
black = math.random(3,1002); 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/AnimeDavid/'..black..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source black     --
if text == "تفعيل فلم" and Manager(msg) and ChCheck(msg) then
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تفعيل الافلام'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:del(black..'black:Movies:black'..msg.chat_id_) 
end
if text == "تعطيل فلم" and Manager(msg) and ChCheck(msg) then
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تعطيل الافلام'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:set(black..'black:Movies:black'..msg.chat_id_,true)  
end
if text and (text == "فلم" or text == "•  فلم • ") and not Devblack:get(black..'black:Movies:black'..msg.chat_id_) and ChCheck(msg) then
black = math.random(45,125); 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MoviesDavid/'..black..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source black     --
if text == "تفعيل مسلسل" and Manager(msg) and ChCheck(msg) then
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تفعيل المسلسلات'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:del(black..'black:Series:black'..msg.chat_id_) 
end
if text == "تعطيل مسلسل" and Manager(msg) and ChCheck(msg) then
local blackTeam = '• ︙اهلا عزيزي •  '..blackRank(msg)..' \n• ︙تم تعطيل المسلسلات'
blackmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, blackTeam, 14, string.len(msg.sender_user_id_))
Devblack:set(black..'black:Series:black'..msg.chat_id_,true)  
end
if text and (text == "مسلسل" or text == "•  مسلسل • ") and not Devblack:get(black..'black:Series:black'..msg.chat_id_) and ChCheck(msg) then
black = math.random(2,54); 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SeriesDavid/'..black..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
