...
JoinChannel = true
local Channel = Redis:get(black..'black:Channel:Join')
if Channel then
...
local msg_id = msg.id
if data.sender.luatele == "messageSenderChat" and Redis:get(black.."Lock:channell"..msg_chat_id) then
print("channel")
...
msg.Name_Controller = 'المطور الثانوي️'
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(black.."black:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊𖤓', url='https://t.me/BLACK_TEAM_4'},
},
}
}
...
if (Redis:get(black..'black:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر ❍' then 
Redis:del(black..'black:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,black).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n❍ البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(black..'black:Channel:Join',ChannelUser) 
Redis:set(black..'black:Channel:Join:Name',UserId_Info.title) 
...
Redis:set(black..'black:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(black..'black:Channel:Join')
...
--download('https://raw.githubusercontent.com/black-TeAm/black/المطور/black.lua','black.lua')
...
listrep = Redis:smembers(black.."black:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(black.."black:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(black.."black:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(black.."black:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(black.."black:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(black.."black:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(black.."black:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(black.."black:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(black.."black:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(black.."black:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(black.."black:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(black.."black:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(black.."black:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(black.."black:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(black.."black:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(black.."black:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(black.."black:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(black.."black:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(black.."black:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(black.."black:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(black.."black:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(black.."black:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(black.."black:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(black.."black:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(black.."black:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(black.."black:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(black.."black:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(black.."black:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(black.."black:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Get_Is_Id = Redis:get(black.."black:Set:Id:Group"..msg_chat_id)
...
local TotalMsg = Redis:get(black..'black:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(black..'black:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n❍ ID 𖦹 '..UserId..
'\n❍ UserName 𖦹 '..UserInfousername..
...
local TotalMsg = Redis:get(black..'black:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(black..'black:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n❍ ID 𖦹 '..UserId..
'\n❍ UserName 𖦹 @'..UserName..
...
if text == 'تغيير Dev' or text == 'تغيير C' then
if not msg.ControllerBot then 
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"❍ تم تنزيله مسبقا المطور الثانوي ").Reply,"md",true)  
else
Redis:srem(black.."black:DevelopersQ:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"❍ تم تنزيله المطور الثانوي").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"❍ تم تنزيله المطور مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."black:Developers:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"❍ تم تنزيله المطور ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"❍ تم تنزيله مسبقا المطور الثانوي ").Reply,"md",true)  
else
Redis:srem(black.."black:DevelopersQ:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"❍ تم تنزيله المطور الثانوي").Reply,"md",true)  
end
end
if TextMsg == 'M' then
if not msg.DevelopersQ then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"❍ تم تنزيله المطور مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."black:Developers:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"❍ تم تنزيله المطور ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"❍ تم تنزيله مسبقا المطور الثانوي ").Reply,"md",true)  
else
Redis:srem(black.."black:DevelopersQ:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"❍ تم تنزيله المطور الثانوي").Reply,"md",true)  
end
end
if UserId[1] == 'M' then
if not msg.DevelopersQ then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"❍ تم تنزيله المطور مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."black:Developers:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"❍ تم تنزيله المطور ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"❍ تم ترقيته مسبقا المطور الثانوي ").Reply,"md",true)  
else
Redis:sadd(black.."black:DevelopersQ:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"❍ تم ترقيته المطور الثانوي").Reply,"md",true)  
end
end
if UserName[1] == "M" then
if not msg.DevelopersQ then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"❍ تم ترقيته المطور الثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."black:DevelopersQ:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"❍ تم ترقيته المطور الثانوي").Reply,"md",true)  
end
end
if TextMsg == 'M' then
if not msg.DevelopersQ then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"❍ تم ترقيته المطور الثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."black:DevelopersQ:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"❍ تم ترقيته المطور الثانوي").Reply,"md",true)  
end
end
if UserId[1] == 'M' then
if not msg.DevelopersQ then
...
if text == 'قائمة MS' or text == 'المطورين الثانوين' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n❍ الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
...
return LuaTele.sendText(msg_chat_id,msg_id,"❍ لا يوجد المطور الثانوي️ حاليا , ","md",true)  
end
ListMembers = '\n❍ قائمة MS\n ••━━━━━ •• 𝐁𝐋𝐀𝐂𝐊•• ━━━━━•• \n'
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح قائمة MS', data = msg.sender.user_id..'/DevelopersQ'},},}}
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"❍ لا يوجد المطور حاليا , ","md",true)  
end
ListMembers = '\n❍ قائمه المطور البوت \n ••━━━━━ •• 𝐁𝐋𝐀𝐂𝐊•• ━━━━━•• \n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
if text and text:match("^(.*)$") then
if Redis:get(black.."black1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(black..'black1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(black..'black1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(black..'black1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(black.."black1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(black.."black1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(black.."black1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(black.."black1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(black.."black1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(black.."black1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(black.."black1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(black.."black1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(black.."black1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(black.."black1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(black.."black1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(black.."black1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(black.."black1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(black.."black1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(black.."black1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(black.."black1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(black.."black1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(black.."black1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(black.."black1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(black.."black1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(black.."black1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(black.."black1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(black.."black1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(black.."black1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(black.."black:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(black.."black:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(black.."black:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(black.."black:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(black.."black:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(black..'black:Add:Rd:Sudo:Text'..text)
Redis:del(black..'black1:Add:Rd:Sudo:Text1'..text)
Redis:del(black..'black:Add:Rd:Sudo:Text2'..text)
Redis:del(black.."black:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(black.."black:List:Rd:Sudo", text)
return false
end
end
...
Redis:del(black.."black1:Add:Rd:Sudo:Text1"..v) 
Redis:del(black.."black:Add:Rd:Sudo:Text2"..v)   
...
Redis:set(black.."black:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(black.."black:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(black.."black:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(black.."black:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(black.."black:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then  
local test = Redis:get(black.."black:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(black.."black:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(black.."black:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(black.."black1:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(black.."black:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(black.."black:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(black.."black:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(black.."black:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(black.."black1:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(black.."black1:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(black.."black1:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(black.."black:allM"..msg.chat_id, msg.id)
if Redis:get(black.."black:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(black.."black:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(black.."black:allM"..msg.chat_id)
...
Redis:del(black.."black:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(black.."black:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(black.."black:allM"..msg.chat_id)  
...
Redis:del(black.."black:Status:Del:Media"..msg.chat_id)
...
Redis:set(black.."black:Status:Del:Media"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'❍ تم تفعيل المسح التلقائي للميديا')
return false
end 
if text == "غنيلي" then
local orab = io.popen('curl -s "https://Black-source.tk/BLACK_TEAM_4/audios.php"'):read('a')
...
{
{text = '❲ 𝐁𝐋𝐀𝐂𝐊 𝐅𝐈𝐋𝐄𝐒🝳 ❳', url = "https://t.me/J_F_A_I"}
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,"[𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊𖤓](t.me/BLACK_TEAM_4)\n\n[𝐁𝐋𝐀𝐂𝐊 𝐅𝐈𝐋𝐄𝐒🝳](t.me/J_F_A_I)","md",true, false, false, false,reply_markup)
end
...
if text == "غادر" or text == "دعبل" then 
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n❍ الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if TextMsg == 'المطورين الثانوين' or TextMsg == 'قائمة MS' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n❍ الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
...
return LuaTele.sendText(msg_chat_id,msg_id,"❍ تم مسح ( "..#Info_Members.." ) من قائمة MS","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"❍ تم مسح ( "..#Info_Members.." ) من المطور ","md",true)
end
...
Redis:set(black.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(black.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(black.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(black.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:set(black.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(black.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(black.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(black.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(black.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(black.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع')
...
local CmdStart = '\n❍ أهلآ بك في بوت '..(Redis:get(black.."black:Name:Bot") or "black")..
...
{
{text = 'قائمة MS',type = 'text'},{text = 'قائمة M',type = 'text'},{text = 'قائمه العام ❍', type = 'text'},
},
{
{text = 'مسح قائمة MS',type = 'text'},{text = 'مسح قائمة M',type = 'text'},{text = 'مسح قائمه العام ❍', type = 'text'},
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,'❍ اهلا بك عزيزي Dev ', 'md', false, false, false, false, reply_markup)
end
end
if text == 'تنظيف المشتركين ❍' then
if not msg.ControllerBot then 
...
Redis:del(black.."black:DevelopersQ:Groups") 
return LuaTele.sendText(msg_chat_id,msg_id,"❍ تم مسح ( "..#Info_Members.." ) من المطور الثانوي️ ","md",true)
end
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح المطور', data = msg.sender.user_id..'/Developers'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
if text == 'قائمة MS' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n❍ الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح MS', data = msg.sender.user_id..'/Developers'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
if not msg.ControllerBot then
...
Redis:srem(black.."black:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(black.."black:BanGroup:Group"..ChatId,listYt[2]) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(black.."black:Redis:Id:Group"..ChatId..""..IdUser,true) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(black.."black:Developers:Groups") 
LuaTele.editMessageText(ChatId,Msg_id,"❍ تم مسح المطورن من البوت", 'md', false)
end
