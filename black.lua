...
return {
Lock     = '[- black 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/black)\n*— — — — — — — — —\n•︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n•︙خاصيه المسح *',
unLock   = '[- black 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/black)\n*— — — — — — — — —\n•︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[- black 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/black)\n*— — — — — — — — —\n•︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n•︙خاصيه الكتم *',
lockKid  = '[- black 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/black)\n*— — — — — — — — —\n•︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n•︙خاصيه التقييد *',
lockKick = '[- black 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/black)\n*— — — — — — — — —\n•︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n•︙خاصيه الطرد *',
Reply    = '[- black 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/black)\n*— — — — — — — — —\n•︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
if text and text:match("^(.*)$") then
if Redis:get(black.."black11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(black.."black11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(black.."black11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(black.."black11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(black.."black11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(black..'black11:Add:Rd:Sudo:Text'..text)
Redis:del(black..'black11:Add:Rd:Sudo:Text1'..text)
Redis:del(black..'black11:Add:Rd:Sudo:Text2'..text)
Redis:del(black.."black11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(black.."black11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(black.."black11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(black.."black11:Add:Rd:Sudo:Text"..v) 
Redis:del(black.."black11:Add:Rd:Sudo:Text1"..v) 
Redis:del(black.."black11:Add:Rd:Sudo:Text2"..v)   
Redis:del(black.."black11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(black.."black11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(black.."black11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(black.."black11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(black.."black11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(black.."black11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(black.."black11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(black.."black11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(black.."black11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(black.."black11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(black.."black11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(black.."black11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(black.."black11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(black.."black11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(black.."black11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(black.."black11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(black.."black11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(black.."black11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:del(black.."black:Status:yt"..msg.chat_id)
...
Redis:set(black.."black:Status:yt"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'•︙تم تفعيل اليوتيوب')
return false
end 
if text and text:match('^بحث (.*)$') and Redis:get(black.."black:Status:yt"..msg.chat_id) then
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendvideo?chat_id=" .. msg_chat_id .. "&video=https://t.me/BLACK_TEAM_4/1596&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.
encode(keyboard))
...
{
{text = '- قناة السورس', url = 't.me/black'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'•︙عليك استخدام اوامر التحكم بالقوائم',"md",false, false, false, false, reply_markup)
...
Redis:set(black.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
...
Redis:set(black.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
local CmdStart = '*\n•︙أهلآ بك في بوت '..(Redis:get(black.."black:Name:Bot") or "سنايبر")..
