...
local TextingDevTheblack = Redis:get(Theblack..'black:Texting:DevTheblack')
if TextingDevTheblack then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevTheblack,"md",true)  
else
...
data = {
{
{text = 'قناة السورس', url = 'https://t.me/BLACK_TEAM_4'}, 
},
{
{text = 'الشروحات', url = 'https://t.me/J_F_A_I'}, 
},
{
{text = 'مطور السورس', url = 't.me/php_cx'}, 
},
{
{text = 'مطور السورس', url = 't.me/V_P_E'}, 
},
{{text = 'اضف البوت لمجموعتك', url = 't.me/'..UserBot..'?startgroup=new'}}, 
}
}
...
if text == (Redis:get(Theblack.."black:Name:Bot") or "بلاك") then
local NamesBot = (Redis:get(Theblack.."black:Name:Bot") or "بلاك")
local NameBots = {
"اسمي "..NamesBot.. " تفضل",
"تدلل.",
"موجود.",
