...
if text == "بوت" then
photo = msg.photo_Controller
local RinkBot = msg.photo_Controller
photo = msg.photo_Controller
local NamesBot = (Redis:get(black.."black:Name:Bot") or "بلاك")
local BotName = {
"اسمي "..NamesBot,
"بيقولو اسمي "..NamesBot.. "",
}
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المطور',url="http://t.me/"..UserSudo..""}},
{{text = 'Source black', url = "http://t.me/BLACK_TEAM_4"}},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(NamesBot).."&photo="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
