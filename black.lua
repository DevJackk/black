...
if text == (Redis:get(Theblack.."black:Name:Bot") or "كادي") then
local NamesBot = (Redis:get(Theblack.."black:Name:Bot") or "كادي")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
if text == '/start' then
photo = "https://t.me/I_RAQ_9/3"
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(Theblack.."black:Name:Bot") or "كادي")..
