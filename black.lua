------------------------------------------------
-- This Source Was Developed By (Joker) @php_cx.--
...
screen -S ]]..Redis:get(SshId.."Info:Redis:User")..[[ ./black
done
]])
Run:close()
...
Status = 0
DevelopersQ = Redis:sismember(black.."DevelopersQ:Groups",UserId) 
HELPBEVQ = Redis:sismember(black.."HELPBEVQ:Groups",UserId) 
Developers = Redis:sismember(black.."Developers:Groups",UserId) 
TheBasics = Redis:sismember(black.."TheBasics:Group"..ChatId,UserId) 
TheBasicsQ = Redis:sismember(black.."TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(black.."Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(black.."Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(black.."Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(black.."Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if tonumber(UserId) ==  1765160742 then
Status = 'المبرمج جوكر' 
elseif tonumber(UserId) == 1965297568 then
Status = 'مبرمج السورس'
elseif tonumber(UserId) ==  1765160742  then
Status = 'مبرمج السورس'
elseif tonumber(UserId) ==  1765160742 then
Status = 'مبرمج السورس'
elseif tonumber(UserId) ==  1765160742 then
...
LuaTele.editMessageText(ChatId,MsgId,"𖤝  صلاحيات الجروب - ", 'md', false, false, reply_markup)
end
...
JoinChannel = true
local Channel = Redis:get(black..'Channel:Join')
if Channel then
...
Redis:sadd(black.."allM"..msg.chat_id, msg.id)
if Redis:get(black.."Status:Del:Media"..msg.chat_id) then    
local Numbardel = Redis:get(black.."allM:numdel"..msg.chat_id) or 200
local gmedia = Redis:scard(black.."allM"..msg.chat_id)  
if tonumber(gmedia) >= tonumber(Numbardel) then
local liste = Redis:smembers(black.."allM"..msg.chat_id)
for k,v in pairs(liste) do
local Mesge = v
if Mesge then
t = "𖤝 تم مسح "..k.." من الوسائط تلقائيا\n𖤝 يمكنك تعطيل الميزه باستخدام الامر ( `تعطيل المسح التلقائي` )"
LuaTele.deleteMessages(msg.chat_id,{[1]= Mesge})
end
end
LuaTele.sendText(msg_chat_id,msg_id, t)
Redis:del(black.."allM"..msg.chat_id)
end
end
end
...
elseif Redis:sismember(black.."DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(black.."HELPBEVQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 22
msg.Name_Controller = 'المساعد'
elseif Redis:sismember(black.."Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(black.."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(black.."TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(black.."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(black.."TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(black.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(black.."Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(black.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(black.."Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(black.."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(black.."Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(black.."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(black.."Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
...
if Redis:get(black.."Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
...
return LuaTele.sendText(msg_chat_id,msg_id,'𖤝 اطلق دخول ['..UserInfo.first_name..'](tg://user?id='..msg.sender.user_id..')\n𖤝 نورت الجروب {'..Get_Chat.title..'}',"md")  
end
end
end
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(black.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(black) then
return false
end
...
if type == "kick" then 
return LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0), LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖤝 قام بالتكرار في الجروب وتم طرده").Reply,"md",true)
end
if type == "del" then 
return LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
if type == "keed" then
return LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0}), LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖤝 قام بالتكرار في الجروب وتم تقييده").Reply,"md",true)  
end
if type == "mute" then
Redis:sadd(black.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖤝 قام بالتكرار في الجروب وتم كتمه").Reply,"md",true)  
end
end
...
if text and Redis:get(black..'lock:Fshar'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(black..'lock:Fars'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(black..'lock:Cht'..msg.chat_id) and not msg.Distinguished then 
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","ابن العرص","منايك","متناك","احا","ابن المتناكه","زبك","عرص","زبي","خول","لبوه","لباوي","ابن اللبوه","منيوك","كسمكك","متناكه","احو","احي","يا عرص","يا خول","قحبه","القحبه","شراميط","العلق","العلوق","العلقه","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","االمنيوك","كسمككك","الشرموطه","ابن العرث","ابن الحيضانه","زبك","خول","زبي","قاحب"}
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
local bot = '𖤝  انا بوت اسمي '..N..'\n𖤝  وظيفتي حمايه الجروب من السبام والتفليش الخ....\n𖤝  لتفعيل البوت قم اضافته للمجموعتك وقم برفعه مشرف واكتب تفعيل\n'
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 لا استطيع تغيير صوره الجروب لاني لست ادمن او ليست لديه الصلاحيه ","md",true)    
end
Redis:del(black.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 تم تغيير صوره الجروب الجروب الى ","md",true)    
end
...
LuaTele.sendText(msg_chat_id,msg_id,"𖤝 تم ازالة هاذا ← { "..text.." }","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"𖤝 لا يوجد امر بهاذا الاسم","md",true)
end
...
Redis:set(black.."Group:Link"..msg_chat_id,LinkGroup)
Redis:del(black.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 تم حفظ ترحيب الجروب","md",true)     
end
...
Redis:del(black.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 تم حفظ قوانين الجروب","md",true)  
end  
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 تم الغاء حفظ وصف الجروب","md",true)   
end 
LuaTele.setChatDescription(msg_chat_id,text) 
Redis:del(black.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 تم حفظ وصف الجروب","md",true)  
end  
...
LuaTele.sendText(msg_chat_id,msg_id,"𖤝  تم حفظ الرد","md",true)  
return false  
end  
end
...
LuaTele.sendText(msg_chat_id,msg_id,"𖤝  تم حذف الرد من الردود ","md",true)  
return false
end
end
...
LuaTele.sendText(msg_chat_id,msg_id,"𖤝  تم حفظ الرد \n𖤝  ارسل ( "..test.." ) لرئية الرد","md",true)  
return false
end  
end
if text and text:match("^(.*)$") then
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝  تم حذف الرد من الردود العامه","md",true)  
end
end
if text then
...
LuaTele.sendText(msg_chat_id,msg_id,'𖤝 تم تعين الايدي الجديد',"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖤝 لقد فزت في اللعبه \n𖤝 اللعب مره اخره وارسل - اعلام","md",true)  
else
Redis:del(black.."Game:Countrygof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖤝 لقد خسرت حظا اوفر في المره القادمه\n𖤝 اللعب مره اخره وارسل - اعلام","md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝 هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'𖤝 عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
...
LuaTele.sendText(msg_chat_id,msg_id,'𖤝 جاري استرجاع المشتركين والجروبات ...')
Y = 0
...
Redis:sadd(black.."TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(black.."Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(black.."Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(black.."Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(black.."Distinguished:Group"..GroupId,v)
end
end 
end
...
if text == 'رفع نسخه بلاك' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝 هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
Redis:sadd(black.."Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(black.."Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(black.."Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(black.."TheBasics:Group"..idg,idASAS)
end;end
end
return LuaTele.sendText(msg_chat_id,msg_id,'𖤝 تم استرجاع المجموعات من نسخه بلاك')
else
return LuaTele.sendText(msg_chat_id,msg_id,'𖤝 الملف لا يدعم هاذا البوت')
end
end
end
...
return LuaTele.sendText(msg.chat_id,msg.id,"𖤝︙اهلا بك عزيزي\n𖤝︙اكتب معرف البوت ثم الرساله ثم معرف الشخص\n𖤝︙مثال\n@php_cxot هاي @php_cx")
end
...
os.execute('wget https://adfrv.zzz.com.ua/beb/black.lua')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝 تم تحديث السورس * ',"md",true)  
end
if text == 'تعطيل الاذاعه 𖤝' or text == 'تعطيل الاذاعه' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝 هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if text == 'تفعيل الاذاعه 𖤝' or text == 'تفعيل الاذاعه' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝 هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if text == 'تعطيل المغادره 𖤝' or text == 'تعطيل المغادره' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝 هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if text == 'تفعيل المغادره 𖤝' or text == 'تفعيل المغادره' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝 هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖤝 عذرآ لا يوجد حساب بهاذا المعرف ","md",true)  
end
if UserId_Info.type.is_channel == true then
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖤝 عذرآ لا تستطيع استخدام معرف قناة او جروب ","md",true)  
end
local Informationlua = io.open("Information.lua", 'w')
Informationlua:write([[
return {
...
local President = Redis:smembers(black.."TheBasics:Group"..v)
local Constructor = Redis:smembers(black.."Originators:Group"..v)
local Manager = Redis:smembers(black.."Managers:Group"..v)
local Admin = Redis:smembers(black.."Addictive:Group"..v)
local Vips = Redis:smembers(black.."Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
if (Redis:get(black..'Channel:Redis'..msg_chat_id..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر 𖤝' then 
Redis:del(black..'Channel:Redis'..msg_chat_id..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(bana.id,black).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖤝 البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(black..'Channel:Join',ChannelUser) 
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖤝 تم تعيين الاشتراك الاجباري على قناة : [@"..ChannelUser..']',"md",true)  
else
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖤝 هاذا ليس معرف قناة يرجى ارسال معرف القناة الصحيح: [@"..ChannelUser..']',"md",true)  
end
end
end
...
Redis:set(black..'Channel:Redis'..msg_chat_id..msg.sender.user_id,true)
...
LuaTele.sendText(msg_chat_id,msg_id,'*𖤝 عدد احصائيات البوت الكامله \n•━━━━━ •• 𝗕𝗟𝗔𝗖𝗞 •• ━━━━━•\n𖤝 عدد المجموعات : '..(Redis:scard(black..'ChekBotAdd') or 0)..'\n𖤝 عدد المشتركين : '..(Redis:scard(black..'Num:User:Pv') or 0)..'*',"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'𖤝 عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(black..'Num:Add:Bot'),"md",true)  
end
...
Redis:set(black.."Status:Id"..msg_chat_id,true) ;Redis:set(black.."Status:Reply"..msg_chat_id,true) ;Redis:set(black.."Status:ReplySudo"..msg_chat_id,true) ;Redis:set(black.."Status:BanId"..msg_chat_id,true) ;Redis:set(black.."Status:SetId"..msg_chat_id,true) 
...
if text == 'رتبتي' then
return LuaTele.sendText(msg_chat_id,msg_id,'\n𖤝︙رتبتك هي : '..msg.Name_Controller,"md",true)  
end
...
if msg.can_be_deleted_for_all_users == false then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*𖤝 عذرآ البوت ليس ادمن في الجروب يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  
end
...
local list = Redis:smembers(black.."allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(black.."allM"..msg.chat_id)  
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝 هاذا الامر يخص { '..Controller_Num(3)..' }* ',"md",true)  
end
Redis:del(black.."Status:Del:Media"..msg.chat_id)
...
Redis:set(black.."Status:Del:Media"..msg.chat_id,true)
...
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝 هاذا الامر يخص { '..Controller_Num(6)..' }* ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(black..'Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n𖤝 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
...
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'𖤝 البوت عضو في الجروب ',"md",true) 
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."DevelopersQ:Groups",bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم تنزيله مطور ثانوي").Reply,"md",true)  
end
end
...
if not Redis:sismember(black.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(black.."HELPBEVQ:Groups")
Redis:del(black.."HELPBEVQ:Groups", bana.id)
Redis:del(black.."id:HELPBEVQ:Groups", bana.id)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم تنزيله مساعد").Reply,"md",true)  
end
end
if UserName[1] == "مطور" then
if not msg.DevelopersQ then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝 هاذا الامر يخص { '..Controller_Num(2)..' }* ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(black..'Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n𖤝 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
if not Redis:sismember(black.."Developers:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."Developers:Groups",bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم تنزيله مطور ").Reply,"md",true)  
end
end
...
if not Redis:sismember(black.."TheBasicsQ:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."TheBasicsQ:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم تنزيله مالك ").Reply,"md",true)  
end
end
if UserName[1] == "منشئ اساسي" then
if not msg.TheBasicsm then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝 هاذا الامر يخص { '..Controller_Num(44)..' }* ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(black..'Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n𖤝 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
if not Redis:sismember(black.."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."TheBasics:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم تنزيله منشئ اساسي ").Reply,"md",true)  
end
end
if UserName[1] == "منشئ" then
if not msg.TheBasics then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝 هاذا الامر يخص { '..Controller_Num(4)..' }* ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(black..'Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n𖤝 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
if not Redis:sismember(black.."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."Originators:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم تنزيله من المنشئين ").Reply,"md",true)  
end
end
if UserName[1] == "مدير" then
if not msg.Originators then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝 هاذا الامر يخص { '..Controller_Num(5)..' }* ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(black..'Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n𖤝 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
if not Redis:sismember(black.."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."Managers:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم تنزيله من المدراء ").Reply,"md",true)  
end
end
...
if not Redis:sismember(black.."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."Addictive:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم تنزيله من الادمنيه ").Reply,"md",true)  
end
end
if UserName[1] == "مميز" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝 هاذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(black..'Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n𖤝 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
if not Redis:sismember(black.."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."Distinguished:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم تنزيله من المميزبن ").Reply,"md",true)  
end
end
end
...
if not Redis:sismember(black.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(black.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(black.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖤝 تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(black.."HELPBEVQ:Groups")
Redis:del(black.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:del(black.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖤝 تم تنزيله مساعد").Reply,"md",true)  
end
end
...
if not Redis:sismember(black.."Developers:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(black.."Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(black.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(black.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(black.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(black.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(black.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(black.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(black.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(black.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(black.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(black.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(black.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(black.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(black.."HELPBEVQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖤝 تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(black.."HELPBEVQ:Groups")
Redis:del(black.."HELPBEVQ:Groups", UserId)
Redis:del(black.."id:HELPBEVQ:Groups", UserId)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖤝 تم تنزيله مساعد").Reply,"md",true)  
end
end
...
if not Redis:sismember(black.."Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖤝 تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."Developers:Groups",UserId) 
...
if not Redis:sismember(black.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖤝 تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(black.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖤝 تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(black.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖤝 تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(black.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖤝 تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(black.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖤝 تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(black.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖤝 تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."DevelopersQ:Groups",bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم ترقيته مطور ثانوي").Reply,"md",true)  
end
end
if UserName[1] == "مساعد" then
if not msg.ControllerBot then 
...
if Redis:sismember(black.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(black.."HELPBEVQ:Groups")
Redis:sadd(black.."HELPBEVQ:Groups", UserId)
Redis:set(black.."id:HELPBEVQ:Groups", UserId)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم ترقيته مساعد").Reply,"md",true)  
end
end
if UserName[1] == "مطور" then
if not msg.DevelopersQ then
...
if Redis:sismember(black.."Developers:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."Developers:Groups",bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم ترقيته مطور ").Reply,"md",true)  
end
end
if UserName[1] == "مالك" then
if not msg.Developers then
...
if Redis:sismember(black.."TheBasicsQ:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."TheBasicsQ:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم ترقيته مالك ").Reply,"md",true)  
end
end
if UserName[1] == "منشئ اساسي" then
if not msg.TheBasicsm then
...
if Redis:sismember(black.."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."TheBasics:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم ترقيته منشئ اساسي ").Reply,"md",true)  
end
end
if UserName[1] == "منشئ" then
if not msg.TheBasics then
...
if Redis:sismember(black.."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."Originators:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم ترقيته منشئ  ").Reply,"md",true)  
end
end
if UserName[1] == "مدير" then
if not msg.Originators then
...
if Redis:sismember(black.."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."Managers:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم ترقيته مدير  ").Reply,"md",true)  
end
end
if UserName[1] == "ادمن" then
if not msg.Managers then
...
if not msg.Originators and not Redis:get(black.."Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(black.."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."Addictive:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم ترقيته ادمن  ").Reply,"md",true)  
end
end
if UserName[1] == "مميز" then
if not msg.Addictive then
...
if Redis:sismember(black.."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."Distinguished:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم ترقيته مميز  ").Reply,"md",true)  
end
end
end
...
if Redis:sismember(black.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(black.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(black.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖤝 تم ترقيته مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(black.."HELPBEVQ:Groups")
Redis:sadd(black.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:set(black.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖤝 تم ترقيته  مساعد").Reply,"md",true)  
end
end
if TextMsg == 'مطور' then
if not msg.DevelopersQ then
...
if Redis:sismember(black.."Developers:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(black.."Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(black.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(black.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(black.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(black.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(black.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(black.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(black.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(black.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(black.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(black.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(black.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(black.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(black.."HELPBEVQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖤝 تم ترقيته مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(black.."HELPBEVQ:Groups")
Redis:sadd(black.."HELPBEVQ:Groups", UserId)
Redis:set(black.."id:HELPBEVQ:Groups", UserId)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖤝 تم مساعد").Reply,"md",true)  
end
end
if UserId[1] == 'مطور' then
if not msg.DevelopersQ then
...
if Redis:sismember(black.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖤝 تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(black.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖤝 تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(black.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖤝 تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(black.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖤝 تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(black.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖤝 تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(black.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖤝 تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝  تم تغير رد المالك الى :"..Teext)
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 تم حذف رد المالك ")
...
local Info_Members = Redis:smembers(black.."DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(black.."Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 لا يوجد مطورين حاليا , ","md",true)  
end
...
local Info_Members = Redis:smembers(black.."TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 لا يوجد مالكين حاليا , ","md",true)  
end
ListMembers = '\n*𖤝 قائمه المالكين \n •━━━━━ •• 𝗕𝗟𝗔𝗖𝗞 •• ━━━━━•*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local Info_Members = Redis:smembers(black.."TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(black.."Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(black.."Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(black.."Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(black.."Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 لا يوجد مكتومين عام حاليا , ","md",true)  
end
ListMembers = '\n*𖤝 قائمه المكتومين عام  \n •━━━━━ •• 𝗕𝗟𝗔𝗖𝗞 •• ━━━━━•*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
if UserInfo and UserInfo.username and UserInfo.username ~= "" then
ListMembers = ListMembers.."*"..k.." - *[@"..UserInfo.username.."](tg://user?id="..v..")\n"
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 تم تفعيل الردود ","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 تم تفعيل الردود العامه ","md",true)
end
...
if TextMsg == 'التحقق' then
    ...
    return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 تم تفعيل التحقق ","md",true)
    end
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 تم تعطيل الردود ","md",true)
end
if TextMsg == 'الردود العامه' then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝 هاذا الامر يخص { '..Controller_Num(6)..' }* ',"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 تم تعطيل الردود العامه ","md",true)
end
if TextMsg == 'الحظر' or TextMsg == 'الطرد' or TextMsg == 'التقييد' then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝 هاذا الامر يخص { '..Controller_Num(6)..' }* ',"md",true)  
...
if TextMsg == 'التحقق' then
    ...
    return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 تم تعطيل التحقق ","md",true)
    end
if TextMsg == 'اطردني' then
...
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝هاذا الامر يخص⦗ '..Controller_Num(1)..' ⦘* ',"md",true)  
end
local bana = LuaTele.searchPublicChat(UserName)
if not bana.id then
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖤝 عذرآ لا يوجد حساب بهاذا المعرف ","md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*𖤝 عذرآ لا تستطيع استخدام الامر على ⦗ "..Controller(msg_chat_id,bana.id).." ⦘ *","md",true)  
end
if StatusCanOrNotCan(msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*𖤝 عذرآ لا تستطيع استخدام الامر على ⦗ "..Controller(msg_chat_id,bana.id).." ⦘ *","md",true)  
end
if Redis:sismember(black.."BanAll:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."BanAll:Groups",bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم حظره عام من المجموعات ").Reply,"md",true)  
end
end
...
if not Redis:sismember(black.."BanAll:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم الغاء حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."BanAll:Groups",bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم الغاء حظره عام من المجموعات  ").Reply,"md",true)  
end
end
...
if Redis:sismember(black.."ktmAll:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."ktmAll:Groups",bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم كتمه عام من المجموعات ").Reply,"md",true)  
end
end
...
if not Redis:sismember(black.."ktmAll:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم الغاء كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."ktmAll:Groups",bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم الغاء كتمه عام من المجموعات  ").Reply,"md",true)  
end
end
...
if not msg.Originators and not Redis:get(black.."Status:BanId"..msg_chat_id) then
...
if Redis:sismember(black.."BanGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."BanGroup:Group"..msg_chat_id,bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم حظره من الجروب ").Reply,"md",true)  
end
end
...
if not Redis:sismember(black.."BanGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."BanGroup:Group"..msg_chat_id,bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم الغاء حظره من الجروب  ").Reply,"md",true)  
end
end
...
if Redis:sismember(black.."SilentGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."SilentGroup:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم كتمه في الجروب  ").Reply,"md",true)  
end
end
...
if not Redis:sismember(black.."SilentGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(black.."SilentGroup:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم تقييده في الجروب \n𖤝 لمدة : "..UserName[1]..' '..UserName[2]).Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖤝 تم تقييده في الجروب \n𖤝 لمدة : "..TimeKed[1]..' '..TimeKed[2]).Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم الغاء تقييده من الجروب").Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖤝 تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖤝 تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖤝 تم الغاء حظره من الجروب  ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖤝 تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖤝 تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖤝 تم الغاء تقييده من الجروب").Reply,"md",true)  
end
...
if UserId == "7676" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*𖤝 عذرآ لا تستطيع استخدام الامر على المطور جوو *","md",true)  
end
if UserId == " 1765160742" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*𖤝 عذرآ لا تستطيع استخدام الامر على مبرمج السورس *","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖤝 تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖤝 تم الغاء كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."ktmAll:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖤝 تم الغاء كتمه عام من المجموعات  ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖤝 تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(black.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\n𖤝 تم الغاء حظره من الجروب \nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
end
keyboard = {} 
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖤝 تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(black.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖤝 تم الغاء حظره من الجروب  ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖤝 تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖤝 تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖤝 تم الغاء تقييده من الجروب").Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"*𖤝 امر نزلني تم تعطيله من قبل المدراء *","md",true)  
end
if The_ControllerAll(msg.sender.user_id) == true then
Rink = 1
elseif Redis:sismember(black.."DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(black.."Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(black.."TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(black.."TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(black.."Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(black.."Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(black.."Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(black.."Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
if Rink == 10 then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*𖤝 ليس لديك رتب عزيزي *","md",true)  
end
if Rink <= 7  then
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 استطيع تنزيل الادمنيه والمميزين فقط","md",true) 
else
Redis:srem(black.."Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(black.."Distinguished:Group"..msg_chat_id, msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 تم تنزيلك من الادمنيه والمميزين ","md",true) 
end
end

if text == "اطردني" or text == "طردني" then
if not Redis:get(black.."Status:KickMe"..msg_chat_id) then
...
if KickMe == true then
return LuaTele.sendText(msg_chat_id,msg_id,"*𖤝 عذرا لا استطيع طرد ادمنيه ومنشئين الجروب*","md",true)    
end
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"𖤝 تم طردك من الجروب بنائآ على طلبك").Reply,"md",true)  
end
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(black.."TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(black.."Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if photo.total_count > 0 then
local TestText = "  ‹[ Owner Groups ]›\n— — — — — — — — —\n 𖤝*Owner Name* :  [".. ban.first_name.."](tg://user?id=".. ban.id..")\n𖤝 *Owner Bio* : [‹[ "..Bio.." ]›]"
keyboardd = {} 
...
if photo.total_count > 0 then
local TestText = "  ‹[ Developers Bot ]›\n— — — — — — — — —\n 𖤝*Dev Name* :  [".. ban.first_name.."](tg://user?id="..Sudo_Id..")\n𖤝 *Dev Bio* : ["..Bio.." ]\n"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = Creat, url = "https://t.me/"..ban.username..""},
...
local TestText = "  ‹[ Developers black  ]›\n— — — — — — — — —\n 𖤝*Dev Name* :  [".. ban.first_name.."](tg://user?id="..Sudo_Id..")\n𖤝 *Dev Bio* : [‹[ "..Bio.." ]›]"
local msg_id = msg.id/2097152/0.5 
...
if text == 'المبرمج جوكر' or text == 'محمد' or text == 'جوكر' then  
...
if photo.total_count > 0 then
local TestText = "  ‹[ black  Source ]›\n— — — — — — — — —\n 𖤝*Dev Name* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n𖤝 *Dev Bio* : [‹[ "..Bio.." ]›]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '< Developers black  >', url = "https://t.me/php_cx"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text == 'المبرمج جاك' or text == 'جاك' or text == 'خالد' then  
...
keyboardd.inline_keyboard = {
{
{text = '< Developers black  >', url = "https://t.me/v_p_e"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
LuaTele.sendText(Sudo_Id,0,'*\n𖤝 مرحباً عزيزي المطور \nشخص ما يحتاج الي مساعده\n•━━━━━ •• 𝗕𝗟𝗔𝗖𝗞 •• ━━━━━•\n𖤝 اسمه :- '..klajq..' \n𖤝 ايديه :-  : '..msg.sender.user_id..'\n𖤝 - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'المبرمج جوكر' or text == 'جوكر' or text == 'محمد' then  
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
local bains = LuaTele.getUser(msg.sender.user_id)
if bains.first_name then
...
LuaTele.sendText( 1765160742,0,'*\n𖤝 مرحباً عزيزي المبرمج جوكر \nشخص ما يحتاج الي مساعده\n•━━━━━ •• 𝗕𝗟𝗔𝗖𝗞 •• ━━━━━•\n𖤝 اسمه :- '..klajq..' \n𖤝 ايديه :-  : '..msg.sender.user_id..'\n𖤝 - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'المبرمج جاك' or text == 'جاك' or text == 'خالد' then  
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
...
LuaTele.sendText(1965297568,0,'*\n𖤝 مرحباً عزيزي المبرمج جاك \nشخص ما يحتاج الي مساعده\n•━━━━━ •• 𝗕𝗟𝗔𝗖𝗞 •• ━━━━━•\n𖤝 اسمه :- '..klajq..' \n𖤝 ايديه :-  : '..msg.sender.user_id..'\n𖤝 - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'المساعد' or text == 'مساعد' then   
local id = Redis:get(black.."id:HELPBEVQ:Groups")
...
local abnj = "*  ‹[ HELP BOT ]›\n— — — — — — — — —\n 𖤝*Dev Name* : "..banyt.result.first_name.." \n"
keybanyt = {} 
...
local TestT = "*  ‹[ HELP BOT ]›\n— — — — — — — — —\n 𖤝*HELP NAME* :  "..banyt.result.first_name.." \n"
keyboardd = {} 
keybanyt.inline_keyboard = {
{
{text = name, url = "https://t.me/"..banyt.result.username..""},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- 𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗟𝗔𝗖𝗞 .',url="t.me/BLACK_TEAM_4"}},
}
local msg_id = msg.id/2097152/0.5
...
keyboardd.inline_keyboard = {
{
{text = '- 𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗟𝗔𝗖𝗞 .', url = "https://t.me/BLACK_TEAM_4"}
},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/remixsource/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,msg.sender.user_id).status.luatele
if (StatusMember == "chatMemberStatusCreator") then
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 انت منشئ الجروب","md",true) 
end
local Added_Me = Redis:get(black.."Who:Added:Me"..msg.sender.user_id..':'..msg.sender.user_id)
if Added_Me then 
ban = LuaTele.getUser(Added_Me)
local Name = '['..ban.first_name..'](tg://user?id='..Added_Me..')'
Text = '𖤝   الشخص الذي قام باضافتك هو ↵ '..Name
...
local list = Redis:smembers(black.."cleaner"..msg_chat_id)
if #list == 0 then 
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝  لا يوجد وسائط مجدوله للحذف \n ","md",true) 
end
for k,v in pairs(list) do 
LuaTele.deleteMessages(msg.chat_id,{[1]= v})
end
Redis:del(black.."cleaner"..msg_chat_id)
LuaTele.sendText(msg_chat_id,msg_id,"𖤝  تم مسح "..#list.." من الميديا","md",true)
end
...
---زخرفة ----
if Redis:get(black.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
LuaTele.sendText(msg_chat_id,msg_id,t,"md",true) 
Redis:del(black.."zhrfa"..msg.sender.user_id) 
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*𖤝 لا توجد صوره ف حسابك*',"md",true) 
end
else
if photo.total_count > 0 then
...
return LuaTele.sendText(msg.chat_id,msg.id,'*\n𖤝- هل انت متأكد بمغادرة البوت - *',"md",false, false, false, false, reply_markup)
end
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖤝 تم قفـل @all هنا").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖤝 تم فتح @all هنا").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖤝 تم قفـل السب").Lock,"md",true)  
end
if text == 'قفل الشتايم'  then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝 هاذا الامر يخص⦗ '..Controller_Num(7)..' ⦘* ',"md",true)  
end
Redis:set(black..'lock:Cht'..msg.chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖤝 تم قفـل السب").Lock,"md",true)  
end
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖤝 تم قفـل الفارسيه").Lock,"md",true)  
end
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖤝 تم فتح السب").unLock,"md",true)  
end
if text == 'فتح الشتايم' then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝 هاذا الامر يخص⦗ '..Controller_Num(7)..' ⦘* ',"md",true)  
end
Redis:del(black..'lock:Cht'..msg.chat_id) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖤝 تم فتح السب").unLock,"md",true)  
end
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖤝 تم فتح الفارسيه").unLock,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 تم ازالة ترحيب الجروب","md",true)   
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 تم ازالة قوانين الجروب","md",true)    
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 ارسل لي وصف الجروب الان","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 تم تغيير اسم الجروب الى : "..NameChat,"md",true)    
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 تم مسح جميع الاوامر التي تم اضافتها في العام","md",true)
end
...
local list = Redis:smembers(black.."All:Command:List:Group")
Command = "𖤝 قائمه الاوامر المضافه العامه  \n•━━━━━ •• 𝗕𝗟𝗔𝗖𝗞 •• ━━━━━•\n"
for k,v in pairs(list) do
...
if #list == 0 then
Command = "𖤝 لا توجد اوامر اضافيه عامه"
end
...
LuaTele.sendText(msg_chat_id,msg_id,"\n𖤝 تم الغاء تثبيت كل الرسائل","md",true)
...
if Redis:get(black.."Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✅ ❭' else StatusReply = '❬ ❎ ❭'
end
if Redis:get(black.."Status:ReplySudo"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(black.."DevelopersQ:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(black.."Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 3
elseif Redis:sismember(black.."TheBasicsQ:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(black.."TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(black.."Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(black.."Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
elseif Redis:sismember(black.."Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 8
elseif Redis:sismember(black.."Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*𖤝 تم تنزيل المستخدم من الرتب التاليه { "..devQ..""..dev..""..crrQ..""..crr..""..cr..""..own..""..mod..""..vip.." *}","md",true)  
end
...
Rink = 1
elseif Redis:sismember(black.."DevelopersQ:Groups",bana.id)  then
Rink = 2
elseif Redis:sismember(black.."Developers:Groups",bana.id)  then
Rink = 3
elseif Redis:sismember(black.."TheBasicsQ:Group"..msg_chat_id, bana.id) then
Rink = 4
elseif Redis:sismember(black.."TheBasics:Group"..msg_chat_id, bana.id) then
Rink = 5
elseif Redis:sismember(black.."Originators:Group"..msg_chat_id, bana.id) then
Rink = 6
elseif Redis:sismember(black.."Managers:Group"..msg_chat_id, bana.id) then
Rink = 7
elseif Redis:sismember(black.."Addictive:Group"..msg_chat_id, bana.id) then
Rink = 8
elseif Redis:sismember(black.."Distinguished:Group"..msg_chat_id, bana.id) then
Rink = 9
else
Rink = 10
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖤝 تم وضع له لقب : "..CustomTitle).Reply,"md",true)  
else
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖤝 عذرآ هناك خطا تاكد من البوت ومن الشخص","md",true)  
end 
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝لقبك هو : '..GeId.result.custom_title..'*',"md",true)  
end
end
...
local SetCustomTitle_ = JSON.decode(SetCustomTitle)
if SetCustomTitle_.result == true then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم وضع له لقب : "..UserName[2]).Reply,"md",true)  
else
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖤝 عذرآ هناك خطا تاكد من البوت ومن الشخص","md",true)  
end 
end 
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖤝 تم تنزيله من المشرفين ").Reply,"md",true)  
end 
...
LuaTele.sendText(msg_chat_id,msg_id,'𖤝 عدد رسائلك هنا *~ '..(Redis:get(black..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'𖤝 عدد التعديلات هنا *~ '..(Redis:get(black..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'𖤝 عدد جهاتك المضافه هنا *~ '..(Redis:get(black.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:del(black.."DevelopersQ:Groups") 
...
Redis:del(black.."Developers:Groups") 
...
Redis:del(black.."TheBasics:Group"..msg_chat_id) 
...
Redis:del(black.."Originators:Group"..msg_chat_id) 
...
Redis:del(black.."Managers:Group"..msg_chat_id) 
...
Redis:del(black.."Addictive:Group"..msg_chat_id) 
...
Redis:del(black.."Distinguished:Group"..msg_chat_id) 
...
return LuaTele.sendText(msg_chat_id,msg_id,"*𖤝 تم مسح {"..#Info_Members.."} من المكتومين عام *","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 تم مسح قائمه الردود","md",true)  
end
if text == ("الردود") then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝 هاذا الامر يخص { '..Controller_Num(6)..' }* ',"md",true)  
...
if #list == 0 then
text = "𖤝 عذرا لا يوجد ردود للمدير في الجروب"
end
return LuaTele.sendText(msg_chat_id,msg_id,"["..text.."]","md",true)  
end
if text == "اضف رد" then
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 ارسل الان الكلمه لاضافتها في الردود ","md",true)  
end
if text == "حذف رد" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝 هاذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 ارسل الان الكلمه لحذفها من الردود","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 تم حذف الردود العامه","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 ارسل الان الكلمه لاضافتها في الردود العامه ","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 ارسل الان الكلمه لحذفها من الردود العامه","md",true)  
end
...
Text =[[
𖤝 Hello pro buttons at the bottom to delete social media accounts .
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'Delete Telegram',url="https://my.telegram.org/auth?to=delete"},{text = 'Delete Bot ',url="https://t.me/DTeLebot"}},
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete Snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},{{text= '- 𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗟𝗔𝗖𝗞 .',url="https://t.me/BLACK_TEAM_4"}}
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/BLACK_TEAM_4/2560&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Name = '* Welcome * ['..RinkBot..'](tg://user?id='..user_info.id..')\n* welcome to sourse black *\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '‹ ᴰᴱᵛᴱᴸᴼᴾᴱᴿ¹ ›', url = "https://t.me/php_cx"},{text = '‹ ᴰᴱᵛᴱᴸᴼᴾᴱᴿ² ›', url = "https://t.me/v_p_e"}
},
{
{text = '- 𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗟𝗔𝗖𝗞 .', url = "https://t.me/BLACK_TEAM_4"}
},
...
if ChannelJoin(msg) == false then
local chinfo = data_ns:get(UserInfo_ns.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n𖤝 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
local reply_markup = LuaTele.replyMarkup{
...
local Namebot = (Redis:get(black.."Name:Bot") or "بلاك")
local BotName = {
'اسمي  '..NamesBot..'🖤',
'اسمي '..NamesBot..'❤️',
'اسمي  '..NamesBot..'♥️',
...
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*𖤝 البوت عظو في الجروب سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 اسرع واحد يدز هاذا السمايل ? ~ {`"..SM.."`}","md",true)  
end
end
...
"‏ علينا إحياء زَمن الرّسائل الورقيّة وسط هذه الفوضى الالكترونية العَارمة. 𖤝💜",
...
"‏ من مراتب التعاسه إطالة الندم ع شيء إنتهى. 𖤝",
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖤝 اسرع واحد يرسل اسم الدولة ~ {"..name.."}","md",true)  
end
end
...
Redis:incrby(black.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:set(black.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(black.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(black.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:set(black.."Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(black.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(black.."Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(black.."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(black.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
...
local CmdStart = '*\n𖤝 أهلآ بك في بوت '..(Redis:get(black.."Name:Bot") or "بلاك")..
'\n𖤝 اختصاص البوت حماية المجموعات'..
'\n𖤝 لتفعيل البوت عليك اتباع مايلي ...'..
'\n𖤝 اضف البوت الى مجموعتك'..
'\n𖤝 ارفعه ادمن {مشرف}'..
'\n𖤝 ارسل كلمة { تفعيل } ليتم تفعيل الجروب'..
...
{
{text = '- المطور .', url ="https://t.me/"..ban.username..""},{text = '- لتنصيب بوتك .', url = 't.me/php_cx'},
},
{
{text = '➕ اضف البوت لمجموعتك', url = 't.me/'..UserBot..'?startgroup=new'}, 
},
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(black.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
end
else
...
data = {
{
{text = 'الاحصائيات 𖤝',type = 'text'},
},
{
{text = 'المبرمج جوكر',type = 'text'},{text = 'المبرمج جاك',type = 'text'},
},
{
{text = 'المساعد',type = 'text'},{text = 'المطور',type = 'text'},
},
{
{text = 'تغيير المطور الاساسي 𖤝',type = 'text'} 
},
{
...
{
{text = 'جلب النسخه الاحتياطيه 𖤝',type = 'text'},
},
{
{text = 'تحديث السورس 𖤝',type = 'text'},
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,'𖤝 اهلا بك عزيزي المطور ', 'md', false, false, false, false, reply_markup)
end
end
...
{
{text = 'تعطيل الاذاعه 𖤝',type = 'text'},{text = 'تفعيل الاذاعه 𖤝',type = 'text'},
},
{
{text = 'تعطيل المغادره 𖤝',type = 'text'},{text = 'تفعيل المغادره 𖤝',type = 'text'},
},
{
{text = 'القائمه الرئيسيه𖤝',type = 'text'},
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'𖤝 اهلا بك عزيزي المطور اوامر التفعيل', 'md', false, false, false, false, reply_markup)
...
return LuaTele.sendText(msg_chat_id,msg_id,'𖤝 اهلا بك عزيزي المطور اوامر الاذاعه', 'md', false, false, false, false, reply_markup)
elseif text == 'القائمه الرئيسيه𖤝' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖤝هاذا الامر يخص⦗ '..Controller_Num(1)..' ⦘* ',"md",true)  
end
local reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
...
return LuaTele.sendText(msg_chat_id,msg_id,'𖤝 اهلا بك عزيزي المطور في الأوامر', 'md', false, false, false, false, reply_markup)
...
{
{text = 'اضف اسم البوت 𖤝',type = 'text'},{text = 'حذف اسم البوت 𖤝', type = 'text'},
},
{
{text = 'اضف اسم للمطور 𖤝',type = 'text'},{text = 'حذف اسم المطور 𖤝', type = 'text'},
},
{
{text = 'تعيين قناه الاشتراك 𖤝',type = 'text'},{text = 'حذف قناه الاشتراك 𖤝', type = 'text'},
},
{
{text = 'اضف كليشه المطور 𖤝',type = 'text'},{text = 'حذف كليشه المطور 𖤝', type = 'text'},
},
{
{text = 'اضف كليشه ستارت 𖤝',type = 'text'},{text = 'حذف كليشه ستارت 𖤝', type = 'text'},
},
{
{text = 'القائمه الرئيسيه𖤝',type = 'text'},
},
...
return LuaTele.sendText(msg_chat_id,msg_id,'𖤝 اهلا بك عزيزي المطور اوامر اضف', 'md', false, false, false, false, reply_markup)
end
...
if text == 'المبرمج جوكر' or text == 'جوكر' or text == 'المبرمج' or text == 'محمد' then  
local UserId_Info = LuaTele.searchPublicChat("php_cx")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(Sudo_Id)
...
if text == 'المبرمج جاك' or text == 'جاك' or text == 'عبدالله' or text == 'خالد' then  
local UserId_Info = LuaTele.searchPublicChat("v_p_e")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(Sudo_Id)
...
Redis:setex(black.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد نص فقط لايدعم الميديا𖤝
 لحماية اقوة ولا يمكن ل المخربين 𖤝
بعمل رد بميديا بغرض التعبير𖤝
]],"md",true)  
return false
end
...
local inget = Redis:get(black..'hmsabots'..ramsesadd[3]..data.sender_user_id)
...
Redis:set(black..'hmsabots'..idnum..UserId_Info.id,username[1])
Redis:set(black..'hmsabots'..idnum..data.sender_user_id,username[1])
end
end
end
...
return LuaTele.sendText(Sudo_Id,0,'*\n𖤝 تم طرد البوت من مجموعه جديده \n𖤝 اسم الجروب : '..Get_Chat.title..'\n𖤝 ايدي الجروب :*`-100'..data.supergroup.id..'`\n𖤝 تم مسح جميع البيانات المتعلقه بالجروب',"md")
end
...
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(black..'Status:joinet'..data.message.chat_id) == 'true' then
    ...
    return LuaTele.sendText(data.message.chat_id, data.message.id, '𖤝 عليك اختيار انا لست بوت لتخطي نضام التحقق', 'md',false, false, false, false, reply_markup)
    end
...
if Text and Text:match('(%d+)/UnKed') then
    ...
    return LuaTele.answerCallbackQuery(data.id, "𖤝 الامر لا يخصك", true)
    end
    LuaTele.setChatMemberStatus(ChatId,UserId,'restricted',{1,1,1,1,1,1,1,1})
    return LuaTele.editMessageText(ChatId,Msg_id,"𖤝 تم التحقق منك اجابتك صحيحه يمكنك الدردشه الان", 'md', false)
    end
...
local TextHelp = [[*
𖤝 اوامر ادمنية الجروب ...
•━━━━━ •• 𝗕𝗟𝗔𝗖𝗞 •• ━━━━━•
𖤝 رفع، تنزيل ↵ مميز
𖤝 تاك للكل ، عدد الجروب
𖤝 كتم ، حظر ، طرد ، تقييد
𖤝 الغاء كتم ، الغاء حظر ، الغاء تقييد
𖤝 منع ، الغاء منع 
•━━━━━ •• 𝗕𝗟𝗔𝗖𝗞 •• ━━━━━•
...
𖤝 مسح الردود العامه ، الردود العامه 
...
𖤝 لعبة الاسئلة ↵ كت تويت
𖤝 لعبة الاعلام والدول ↵ اعلام
•━━━━━ •• 𝗕𝗟𝗔𝗖𝗞 •• ━━━━━•
𖤝 نقاطي ↵ لعرض عدد الارباح
𖤝 بيع نقاطي ↵ ⦗ العدد  ⦘↵ لبيع كل نقطه مقابل {50} رساله
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
if tonumber(IdUser) == tonumber(UserId) then
LuaTele.editMessageText(ChatId,Msg_id,"*𖤝 تم رفض الزواج من الزوجه*","md",true) 
end
end
if Text == '/leftz@' then
LuaTele.editMessageText(ChatId,Msg_id,"*𖤝 ارسل الكلمه لزخرفتها عربي او انجلش*","md",true) 
Redis:set(black.."zhrfa"..IdUser,"sendzh") 
end 
if Text == '/leftz@' then
LuaTele.editMessageText(ChatId,Msg_id,"*𖤝 ارسل الكلمه لزخرفتها عربي او انجلش*","md",true) 
Redis:set(black.."zhrfa"..IdUser,"sendzh") 
...
if tonumber(IdUser) == tonumber(UserId) then
LuaTele.editMessageText(ChatId,Msg_id,"*𖤝 ارسل رساله المساعده*","md",true) 
Redis:set(black.."rank_tf"..IdUser,"rank_tk") 
end
end 
...
if tonumber(IdUser) == tonumber(UserId) then
LuaTele.editMessageText(ChatId,Msg_id,"*𖤝 ارسل معرف المطور الاساسي مع @*","md",true) 
Redis:set(black.."AddSudosNew"..ChatId,true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(black.."AddSudosNew"..ChatId)
LuaTele.editMessageText(ChatId,Msg_id,"*𖤝 تم الغاء امر تغيير المطور الاساسي*","md",true) 
end
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➣ .', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"𖤝 تم تعطيل امر الردود").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➣ .', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"𖤝 تم تعطيل امر الردود العامه").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➣ .', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"𖤝 تم تفعيل امر الردود").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➣ .', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"𖤝 تم تفعيل امر الردود العامه").unLock, 'md', true, false, reply_markup)
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(black.."rb:bna"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➣ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(black.."TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(black.."Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:del(black.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(black..''..lock..UserId[2],"del")    
end
LuaTele.answerCallbackQuery(data.id, "𖤝 تم قفل جميع الاوامر بنجاح  ", true)
end
end
...
LuaTele.answerCallbackQuery(data.id, "𖤝 تم مغادره البوت من الجروب", true)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(black.."TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(black.."TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(black.."Originators:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"𖤝 تم مسح منشئين الجروب", 'md', false)
end
elseif Text and Text:match('(%d+)/Managers') then
local UserId = Text:match('(%d+)/Managers')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(black.."Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(black.."Addictive:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"𖤝 تم مسح ادمنيه الجروب", 'md', false)
end
elseif Text and Text:match('(%d+)/DelDistinguished') then
local UserId = Text:match('(%d+)/DelDistinguished')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(black.."Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➣ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(black.."ktmAll:Groups") 
LuaTele.editMessageText(ChatId,Msg_id,"𖤝 تم مسح المكتومين عام", 'md', false)
end
