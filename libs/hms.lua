--[[
BY : blackTEAM
Channel Files : https://t.me/BLACK_TEAM_4
]]
local function keko_black(data)
    ...
    local keko_add_sudo = redis:get('black:'..bot_id..'sudoo'..user_id..'')
    ...
    dl_cb, nil)
    database:set("black:get:hms:msg:"..bot_id..msg.chat_id_..msg.id_..t2.id_,keko_ts[1])
    ...
    resolve_username(keko_ts[2],cb_black)
    end
    end
    ...
    kekol = database:get("black:get:hms:msg:"..bot_id..keko_ts[1]..keko_ts[2])
    if kekol then 
